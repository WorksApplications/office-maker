...
var _user$project$Util_File$getSizeOfImage = _user$project$Native_File.getSizeOfImage;
var _user$project$Util_File$length = function (_p0) {
	var _p1 = _p0;
	return _user$project$Native_File.length(_p1._0);
};
var _user$project$Util_File$FileList = function (a) {
	return {ctor: 'FileList', _0: a};
};
var _user$project$Util_File$decodeFile = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Util_File$FileList,
	A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['target', 'files']),
		_elm_lang$core$Json_Decode$value));
var _user$project$Util_File$File = function (a) {
	return {ctor: 'File', _0: a};
};
var _user$project$Util_File$getAt = F2(
	function (index, fileList) {
		var _p2 = fileList;
		return ((_elm_lang$core$Native_Utils.cmp(0, index) < 1) && (_elm_lang$core$Native_Utils.cmp(
			index,
			_user$project$Util_File$length(fileList)) < 0)) ? _elm_lang$core$Maybe$Just(
			_user$project$Util_File$File(
				A2(_user$project$Native_File.getAt, index, _p2._0))) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Util_File$Unexpected = function (a) {
	return {ctor: 'Unexpected', _0: a};
};
var _user$project$Util_File$readAsDataURL = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._0;
	return A2(
		_elm_lang$core$Task$mapError,
		_elm_lang$core$Basics$always(
			_user$project$Util_File$Unexpected(
				_elm_lang$core$Basics$toString(_p5))),
		_user$project$Native_File.readAsDataURL(_p5));
};

var _user$project$Util_HttpUtil$promoteError = function (rawError) {
	var _p0 = rawError;
...
var _user$project$Util_HttpUtil$handleResponse = F2(
	function (handle, response) {
		if ((_elm_lang$core$Native_Utils.cmp(200, response.status) < 1) && (_elm_lang$core$Native_Utils.cmp(response.status, 300) < 0)) {
...
var _user$project$Util_HttpUtil$fromText = F2(
	function (decoder, response) {
		var decode = function (str) {
			var _p2 = decoder(str);
			if (_p2.ctor === 'Ok') {
				...
				return _elm_lang$core$Task$fail(
					_evancz$elm_http$Http$UnexpectedPayload(_p2._0));
			}
		};
		return A2(
			_elm_lang$core$Task$andThen,
			A2(_elm_lang$core$Task$mapError, _user$project$Util_HttpUtil$promoteError, response),
			_user$project$Util_HttpUtil$handleResponse(decode));
	});
var _user$project$Util_HttpUtil$fromJson = F2(
	function (decoder, response) {
		return A2(
			_user$project$Util_HttpUtil$fromText,
			_elm_lang$core$Json_Decode$decodeString(decoder),
			response);
	});
var _user$project$Util_HttpUtil$textResponse = function (response) {
	return A2(_user$project$Util_HttpUtil$fromText, _elm_lang$core$Result$Ok, response);
};
var _user$project$Util_HttpUtil$noResponse = function (response) {
	return A2(
		_user$project$Util_HttpUtil$fromText,
		_elm_lang$core$Basics$always(
...
var _user$project$Util_HttpUtil$recover404With = F2(
	function (alt, e) {
		var _p3 = e;
		if ((_p3.ctor === 'BadResponse') && (_p3._0 === 404)) {
			return _elm_lang$core$Task$succeed(alt);
		} else {
			return _elm_lang$core$Task$fail(e);
		}
	});
var _user$project$Util_HttpUtil$defaultSettingsWithCredentials = function () {
	var settings = _evancz$elm_http$Http$defaultSettings;
	return _elm_lang$core$Native_Utils.update(
		settings,
		{withCredentials: true});
}();
var _user$project$Util_HttpUtil$authorization = function (s) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'Authorization', _1: s}
		]);
};
var _user$project$Util_HttpUtil$contentTypeJsonUtf8 = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'Content-Type', _1: 'application/json; charset=utf-8'}
	]);
var _user$project$Util_HttpUtil$sendJson = F5(
	function (verb, decoder, url, headers, body) {
		var request = {
			verb: verb,
			headers: A2(_elm_lang$core$Basics_ops['++'], _user$project$Util_HttpUtil$contentTypeJsonUtf8, headers),
			url: url,
			body: body
		};
		return A2(
			_evancz$elm_http$Http$fromJson,
			decoder,
			A2(_evancz$elm_http$Http$send, _user$project$Util_HttpUtil$defaultSettingsWithCredentials, request));
	});
var _user$project$Util_HttpUtil$postJson = _user$project$Util_HttpUtil$sendJson('POST');
var _user$project$Util_HttpUtil$putJson = _user$project$Util_HttpUtil$sendJson('PUT');
var _user$project$Util_HttpUtil$patchJson = _user$project$Util_HttpUtil$sendJson('PATCH');
var _user$project$Util_HttpUtil$deleteJson = _user$project$Util_HttpUtil$sendJson('DELETE');
var _user$project$Util_HttpUtil$sendJsonNoResponse = F4(
	function (verb, url, headers, body) {
		var request = {
			verb: verb,
			headers: A2(_elm_lang$core$Basics_ops['++'], _user$project$Util_HttpUtil$contentTypeJsonUtf8, headers),
			url: url,
		...
		return _user$project$Util_HttpUtil$noResponse(
			A2(_evancz$elm_http$Http$send, _user$project$Util_HttpUtil$defaultSettingsWithCredentials, request));
	});
var _user$project$Util_HttpUtil$postJsonNoResponse = _user$project$Util_HttpUtil$sendJsonNoResponse('POST');
var _user$project$Util_HttpUtil$putJsonNoResponse = _user$project$Util_HttpUtil$sendJsonNoResponse('PUT');
var _user$project$Util_HttpUtil$deleteJsonNoResponse = _user$project$Util_HttpUtil$sendJsonNoResponse('DELETE');
var _user$project$Util_HttpUtil$sendJsonTextResponse = F4(
	function (verb, url, headers, body) {
		var request = {
			verb: verb,
			headers: A2(_elm_lang$core$Basics_ops['++'], _user$project$Util_HttpUtil$contentTypeJsonUtf8, headers),
		...
		return _user$project$Util_HttpUtil$textResponse(
			A2(_evancz$elm_http$Http$send, _user$project$Util_HttpUtil$defaultSettingsWithCredentials, request));
	});
var _user$project$Util_HttpUtil$postJsonTextResponse = _user$project$Util_HttpUtil$sendJsonTextResponse('POST');
var _user$project$Util_HttpUtil$get = F3(
	function (decoder, url, headers) {
		var request = {
			verb: 'GET',
			headers: A2(_elm_lang$core$Basics_ops['++'], _user$project$Util_HttpUtil$contentTypeJsonUtf8, headers),
			url: url,
...
var _user$project$Util_HttpUtil$getWithoutCache = F3(
	function (decoder, url, headers) {
		var headers$ = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'Pragma', _1: 'no-cache'},
					{ctor: '_Tuple2', _0: 'Cache-Control', _1: 'no-cache'},
					{ctor: '_Tuple2', _0: 'If-Modified-Since', _1: 'Thu, 01 Jun 1970 00:00:00 GMT'}
				]),
			headers);
		return A3(_user$project$Util_HttpUtil$get, decoder, url, headers$);
	});
var _user$project$Util_HttpUtil$encodeHeaders = function (headers) {
				...
				return _elm_lang$core$Json_Encode$list(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Json_Encode$string(_p5._1)
						]));
			},
			headers));
};
var _user$project$Util_HttpUtil$sendFile = F4(
	function (method, url, headers, _p6) {
		var _p7 = _p6;
		return A4(
			_user$project$Native_HttpUtil.sendFile,
			method,
			url,
			_user$project$Util_HttpUtil$encodeHeaders(headers),
			_p7._0);
	});
var _user$project$Util_HttpUtil$goTo = _user$project$Native_HttpUtil.goTo;
var _user$project$Util_HttpUtil$reload = _user$project$Native_HttpUtil.reload;

var _user$project$Model_Person$Person = F6(
	function (a, b, c, d, e, f) {
		return {id: a, name: b, post: c, mail: d, tel: e, image: f};
	});

var _user$project$Model_Object$fontSizeEditable = function (_p0) {
	return true;
};
var _user$project$Model_Object$backgroundColorEditable = function (_p1) {
	return true;
};
var _user$project$Model_Object$relatedPerson = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3._0.extension;
	if (_p4.ctor === 'Desk') {
		return _p4._0;
	} else {
		return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Model_Object$rect = function (_p5) {
	var _p6 = _p5;
	return _p6._0.rect;
};
var _user$project$Model_Object$fontSizeOf = function (_p7) {
	var _p8 = _p7;
	return _p8._0.fontSize;
};
var _user$project$Model_Object$defaultFontSize = 16;
var _user$project$Model_Object$colorOf = function (_p9) {
	var _p10 = _p9;
	var _p11 = _p10._0.extension;
	if (_p11.ctor === 'Desk') {
		return '#000';
	} else {
		return _p11._0;
...
var _user$project$Model_Object$backgroundColorOf = function (_p12) {
	var _p13 = _p12;
	return _p13._0.backgroundColor;
};
var _user$project$Model_Object$nameOf = function (_p14) {
	var _p15 = _p14;
	return _p15._0.name;
};
var _user$project$Model_Object$idOf = function (_p16) {
	var _p17 = _p16;
	return _p17._0.id;
};
var _user$project$Model_Object$position = function (_p18) {
	var _p19 = _p18;
	var _p20 = _p19._0.rect;
	return {ctor: '_Tuple2', _0: _p20._0, _1: _p20._1};
};
var _user$project$Model_Object$isLabel = function (_p21) {
	var _p22 = _p21;
	var _p23 = _p22._0.extension;
	if (_p23.ctor === 'Label') {
		return true;
	} else {
		return false;
...
var _user$project$Model_Object$colorEditable = _user$project$Model_Object$isLabel;
var _user$project$Model_Object$shapeEditable = _user$project$Model_Object$isLabel;
var _user$project$Model_Object$isDesk = function (_p24) {
	var _p25 = _p24;
	var _p26 = _p25._0.extension;
	if (_p26.ctor === 'Desk') {
		return true;
	} else {
		return false;
...
var _user$project$Model_Object$Ellipse = {ctor: 'Ellipse'};
var _user$project$Model_Object$Rectangle = {ctor: 'Rectangle'};
var _user$project$Model_Object$shapeOf = function (_p27) {
	var _p28 = _p27;
	var _p29 = _p28._0.extension;
	if (_p29.ctor === 'Desk') {
		return _user$project$Model_Object$Rectangle;
	} else {
		return _p29._1;
	}
};
var _user$project$Model_Object$Object = function (a) {
	return {ctor: 'Object', _0: a};
};
var _user$project$Model_Object$changeId = F2(
	function (id, _p30) {
		var _p31 = _p30;
		return _user$project$Model_Object$Object(
			_elm_lang$core$Native_Utils.update(
				_p31._0,
				{id: id}));
	});
var _user$project$Model_Object$changeBackgroundColor = F2(
	function (backgroundColor, _p32) {
		var _p33 = _p32;
		return _user$project$Model_Object$Object(
			_elm_lang$core$Native_Utils.update(
				_p33._0,
...
var _user$project$Model_Object$changeName = F2(
	function (name, _p34) {
		var _p35 = _p34;
		return _user$project$Model_Object$Object(
			_elm_lang$core$Native_Utils.update(
...
var _user$project$Model_Object$changeSize = F2(
	function (_p37, _p36) {
		var _p38 = _p37;
		var _p39 = _p36;
		var _p41 = _p39._0;
		...
		return _user$project$Model_Object$Object(
			_elm_lang$core$Native_Utils.update(
				_p41,
				{
					rect: {ctor: '_Tuple4', _0: _p40._0, _1: _p40._1, _2: _p38._0, _3: _p38._1}
				}));
	});
var _user$project$Model_Object$move = F2(
	function (_p43, _p42) {
		var _p44 = _p43;
		var _p45 = _p42;
		var _p47 = _p45._0;
		...
		return _user$project$Model_Object$Object(
			_elm_lang$core$Native_Utils.update(
				_p47,
				{
					rect: {ctor: '_Tuple4', _0: _p44._0, _1: _p44._1, _2: _p46._2, _3: _p46._3}
				}));
	});
var _user$project$Model_Object$copy = F3(
	function (newId, pos, object) {
		return function (_p48) {
			return A2(
				_user$project$Model_Object$changeId,
				newId,
				A2(_user$project$Model_Object$move, pos, _p48));
		}(object);
	});
var _user$project$Model_Object$rotate = function (_p49) {
	var _p50 = _p49;
	var _p52 = _p50._0;
	var _p51 = _p52.rect;
	return _user$project$Model_Object$Object(
		_elm_lang$core$Native_Utils.update(
			_p52,
			{
				rect: {ctor: '_Tuple4', _0: _p51._0, _1: _p51._1, _2: _p51._3, _3: _p51._2}
			}));
};
var _user$project$Model_Object$changeFontSize = F2(
	function (fontSize, _p53) {
		var _p54 = _p53;
		return _user$project$Model_Object$Object(
			_elm_lang$core$Native_Utils.update(
				_p54._0,
...
var _user$project$Model_Object$Label = F2(
	function (a, b) {
		return {ctor: 'Label', _0: a, _1: b};
	});
var _user$project$Model_Object$initLabel = F7(
	function (id, rect, backgroundColor, name, fontSize, color, shape) {
		return _user$project$Model_Object$Object(
			{
				id: id,
				rect: rect,
				...
				name: name,
				fontSize: fontSize,
				extension: A2(_user$project$Model_Object$Label, color, shape)
			});
	});
var _user$project$Model_Object$changeColor = F2(
	function (color, _p55) {
		var _p56 = _p55;
		var _p58 = _p56._0;
		var _p57 = _p58.extension;
		if (_p57.ctor === 'Desk') {
			return _user$project$Model_Object$Object(_p58);
		} else {
			return _user$project$Model_Object$Object(
				_elm_lang$core$Native_Utils.update(
					_p58,
					{
						extension: A2(_user$project$Model_Object$Label, color, _p57._1)
					}));
		}
	});
var _user$project$Model_Object$changeShape = F2(
	function (shape, _p59) {
		var _p60 = _p59;
		var _p62 = _p60._0;
		var _p61 = _p62.extension;
		if (_p61.ctor === 'Desk') {
			return _user$project$Model_Object$Object(_p62);
		} else {
			return _user$project$Model_Object$Object(
				_elm_lang$core$Native_Utils.update(
					_p62,
					{
						extension: A2(_user$project$Model_Object$Label, _p61._0, shape)
					}));
		}
	});
var _user$project$Model_Object$Desk = function (a) {
	return {ctor: 'Desk', _0: a};
};
var _user$project$Model_Object$initDesk = F6(
	function (id, rect, backgroundColor, name, fontSize, personId) {
		return _user$project$Model_Object$Object(
			{
				id: id,
				rect: rect,
				...
				name: name,
				fontSize: fontSize,
				extension: _user$project$Model_Object$Desk(personId)
			});
	});
var _user$project$Model_Object$setPerson = F2(
	function (personId, _p63) {
		var _p64 = _p63;
		var _p66 = _p64._0;
		var _p65 = _p66.extension;
		if (_p65.ctor === 'Desk') {
			return _user$project$Model_Object$Object(
				_elm_lang$core$Native_Utils.update(
					_p66,
			...
			return _user$project$Model_Object$Object(_p66);
		}
	});

var _user$project$Util_ListUtil$getAt = F2(
	function (idx, xs) {
		return (_elm_lang$core$Native_Utils.cmp(idx, 0) < 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, idx, xs));
	});
var _user$project$Util_ListUtil$zipWithIndexFrom = F2(
	function (index, list) {
		var _p0 = list;
		if (_p0.ctor === '::') {
			return A2(
				...
				A2(_user$project$Util_ListUtil$zipWithIndexFrom, index + 1, _p0._1));
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		}
	});
var _user$project$Util_ListUtil$zipWithIndex = _user$project$Util_ListUtil$zipWithIndexFrom(0);
var _user$project$Util_ListUtil$findBy = F2(
	function (f, list) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$filter, f, list));
	});

var _user$project$Model_ObjectsOperation$collectSameProperty = F2(
	function (getProp, selectedObjects) {
		var _p0 = _elm_lang$core$List$head(selectedObjects);
		if (_p0.ctor === 'Just') {
			var firstProp = getProp(_p0._0);
			return A3(
				_elm_lang$core$List$foldl,
				F2(
					function (e, maybeProp) {
						var prop = getProp(e);
						var _p1 = maybeProp;
						if (_p1.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(prop, _p1._0) ? _elm_lang$core$Maybe$Just(prop) : _elm_lang$core$Maybe$Nothing;
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					}),
				_elm_lang$core$Maybe$Just(firstProp),
				selectedObjects);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Model_ObjectsOperation$fontSizeProperty = function (selectedObjects) {
	return A2(_user$project$Model_ObjectsOperation$collectSameProperty, _user$project$Model_Object$fontSizeOf, selectedObjects);
};
var _user$project$Model_ObjectsOperation$nameProperty = function (selectedObjects) {
	return A2(_user$project$Model_ObjectsOperation$collectSameProperty, _user$project$Model_Object$nameOf, selectedObjects);
};
var _user$project$Model_ObjectsOperation$shapeProperty = function (selectedObjects) {
	return A2(_user$project$Model_ObjectsOperation$collectSameProperty, _user$project$Model_Object$shapeOf, selectedObjects);
};
var _user$project$Model_ObjectsOperation$colorProperty = function (selectedObjects) {
	return A2(_user$project$Model_ObjectsOperation$collectSameProperty, _user$project$Model_Object$colorOf, selectedObjects);
};
var _user$project$Model_ObjectsOperation$backgroundColorProperty = function (selectedObjects) {
	return A2(_user$project$Model_ObjectsOperation$collectSameProperty, _user$project$Model_Object$backgroundColorOf, selectedObjects);
};
var _user$project$Model_ObjectsOperation$fitSizeToGrid = F2(
	function (gridSize, _p2) {
		var _p3 = _p2;
		return {ctor: '_Tuple2', _0: ((_p3._0 / gridSize) | 0) * gridSize, _1: ((_p3._1 / gridSize) | 0) * gridSize};
	});
var _user$project$Model_ObjectsOperation$fitPositionToGrid = F2(
	function (gridSize, _p4) {
		var _p5 = _p4;
		return {ctor: '_Tuple2', _0: ((_p5._0 / gridSize) | 0) * gridSize, _1: ((_p5._1 / gridSize) | 0) * gridSize};
	});
var _user$project$Model_ObjectsOperation$findObjectById = F2(
	function (objects, id) {
		return A2(
			_user$project$Util_ListUtil$findBy,
			function (object) {
				return _elm_lang$core$Native_Utils.eq(
					id,
					_user$project$Model_Object$idOf(object));
			},
			objects);
	});
var _user$project$Model_ObjectsOperation$partiallyChange = F3(
	function (f, ids, objects) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return A2(
					_elm_lang$core$List$member,
					_user$project$Model_Object$idOf(e),
					ids) ? f(e) : e;
			},
			objects);
	});
var _user$project$Model_ObjectsOperation$moveObjects = F4(
	function (gridSize, _p6, ids, objects) {
		var _p7 = _p6;
		return A3(
			_user$project$Model_ObjectsOperation$partiallyChange,
			function (e) {
				var _p8 = _user$project$Model_Object$rect(e);
				var x = _p8._0;
				var y = _p8._1;
				var _p9 = A2(
					_user$project$Model_ObjectsOperation$fitPositionToGrid,
					gridSize,
					{ctor: '_Tuple2', _0: x + _p7._0, _1: y + _p7._1});
				var newX = _p9._0;
				var newY = _p9._1;
				return A2(
					_user$project$Model_Object$move,
...
var _user$project$Model_ObjectsOperation$pasteObjects = F3(
	function (_p10, copiedWithNewIds, allObjects) {
		var _p11 = _p10;
		var _p12 = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p14, _p13) {
					var _p15 = _p14;
					var _p16 = _p13;
					var _p17 = _user$project$Model_Object$position(_p15._0);
					var x = _p17._0;
					var y = _p17._1;
					return {
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Basics$min, _p16._0, x),
						_1: A2(_elm_lang$core$Basics$min, _p16._1, y)
					};
				}),
		...
		var newObjects = A2(
			...
			function (_p18) {
				var _p19 = _p18;
				var _p21 = _p19._0;
				var _p20 = _user$project$Model_Object$position(_p21);
				var x = _p20._0;
				var y = _p20._1;
				return A3(
					_user$project$Model_Object$copy,
					_p19._1,
					{ctor: '_Tuple2', _0: _p11._0 + (x - minX), _1: _p11._1 + (y - minY)},
					_p21);
			},
			copiedWithNewIds);
		return newObjects;
	});
var _user$project$Model_ObjectsOperation$compareBoundBy = F3(
	function (direction, e1, e2) {
		var _p22 = _user$project$Model_Object$rect(e2);
		var left2 = _p22._0;
		var top2 = _p22._1;
		var w2 = _p22._2;
		var h2 = _p22._3;
		var right2 = left2 + w2;
		var bottom2 = top2 + h2;
		var _p23 = _user$project$Model_Object$rect(e1);
		var left1 = _p23._0;
		var top1 = _p23._1;
		var w1 = _p23._2;
		var h1 = _p23._3;
		...
		switch (_p24.ctor) {
			case 'Up':
				return _elm_lang$core$Native_Utils.eq(top1, top2) ? _elm_lang$core$Basics$EQ : ((_elm_lang$core$Native_Utils.cmp(top1, top2) < 0) ? _elm_lang$core$Basics$GT : _elm_lang$core$Basics$LT);
			case 'Down':
				return _elm_lang$core$Native_Utils.eq(bottom1, bottom2) ? _elm_lang$core$Basics$EQ : ((_elm_lang$core$Native_Utils.cmp(bottom1, bottom2) > 0) ? _elm_lang$core$Basics$GT : _elm_lang$core$Basics$LT);
			case 'Left':
				return _elm_lang$core$Native_Utils.eq(left1, left2) ? _elm_lang$core$Basics$EQ : ((_elm_lang$core$Native_Utils.cmp(left1, left2) < 0) ? _elm_lang$core$Basics$GT : _elm_lang$core$Basics$LT);
			default:
				return _elm_lang$core$Native_Utils.eq(right1, right2) ? _elm_lang$core$Basics$EQ : ((_elm_lang$core$Native_Utils.cmp(right1, right2) > 0) ? _elm_lang$core$Basics$GT : _elm_lang$core$Basics$LT);
		}
	});
var _user$project$Model_ObjectsOperation$minimumPartsOf = F2(
	function (direction, list) {
		var f = F2(
			function (e, memo) {
				var _p25 = memo;
				if (_p25.ctor === '::') {
					var _p26 = A3(_user$project$Model_ObjectsOperation$compareBoundBy, direction, e, _p25._0);
					switch (_p26.ctor) {
						case 'LT':
							return _elm_lang$core$Native_List.fromArray(
								[e]);
						case 'EQ':
							return A2(_elm_lang$core$List_ops['::'], e, memo);
						default:
							return memo;
					}
				} else {
...
var _user$project$Model_ObjectsOperation$restOfMinimumPartsOf = F2(
	function (direction, list) {
		var minimumParts = A2(_user$project$Model_ObjectsOperation$minimumPartsOf, direction, list);
		return A2(
			_elm_lang$core$List$filter,
			function (e) {
				return _elm_lang$core$Basics$not(
					A2(_elm_lang$core$List$member, e, minimumParts));
			},
			list);
	});
var _user$project$Model_ObjectsOperation$maximumPartsOf = F2(
	function (direction, list) {
		var f = F2(
			function (e, memo) {
				var _p27 = memo;
				if (_p27.ctor === '::') {
					var _p28 = A3(_user$project$Model_ObjectsOperation$compareBoundBy, direction, e, _p27._0);
					switch (_p28.ctor) {
						case 'LT':
							return memo;
						case 'EQ':
...
var _user$project$Model_ObjectsOperation$restOfMaximumPartsOf = F2(
	function (direction, list) {
		var maximumParts = A2(_user$project$Model_ObjectsOperation$maximumPartsOf, direction, list);
		return A2(
			_elm_lang$core$List$filter,
			function (e) {
				return _elm_lang$core$Basics$not(
					A2(_elm_lang$core$List$member, e, maximumParts));
			},
			list);
	});
var _user$project$Model_ObjectsOperation$bound = F2(
	function (direction, object) {
		var _p29 = _user$project$Model_Object$rect(object);
		var left = _p29._0;
		var top = _p29._1;
		var w = _p29._2;
		var h = _p29._3;
...
var _user$project$Model_ObjectsOperation$bounds = function (list) {
	var f = F2(
		function (e1, memo) {
			var _p31 = _user$project$Model_Object$rect(e1);
			var x1 = _p31._0;
			var y1 = _p31._1;
			var w1 = _p31._2;
			var h1 = _p31._3;
			...
			if (_p32.ctor === 'Just') {
				return _elm_lang$core$Maybe$Just(
					{
						ctor: '_Tuple4',
						_0: A2(_elm_lang$core$Basics$min, _p32._0._0, x1),
						_1: A2(_elm_lang$core$Basics$min, _p32._0._1, y1),
						_2: A2(_elm_lang$core$Basics$max, _p32._0._2, right1),
						_3: A2(_elm_lang$core$Basics$max, _p32._0._3, bottom1)
					});
			} else {
				return _elm_lang$core$Maybe$Just(
					{ctor: '_Tuple4', _0: x1, _1: y1, _2: right1, _3: bottom1});
			}
		});
	return A3(_elm_lang$core$List$foldl, f, _elm_lang$core$Maybe$Nothing, list);
};
var _user$project$Model_ObjectsOperation$linked = F2(
	function (_p34, _p33) {
		var _p35 = _p34;
		var _p40 = _p35._1;
		var _p39 = _p35._0;
		...
		var _p38 = _p36._1;
		var _p37 = _p36._0;
		return (_elm_lang$core$Native_Utils.cmp(_p39, _p37 + _p36._2) < 1) && ((_elm_lang$core$Native_Utils.cmp(_p37, _p39 + _p35._2) < 1) && ((_elm_lang$core$Native_Utils.cmp(_p40, _p38 + _p36._3) < 1) && (_elm_lang$core$Native_Utils.cmp(_p38, _p40 + _p35._3) < 1)));
	});
var _user$project$Model_ObjectsOperation$linkedByAnyOf = F2(
	function (list, newObject) {
		return A2(
			_elm_lang$core$List$any,
			function (e) {
				return A2(
					_user$project$Model_ObjectsOperation$linked,
					_user$project$Model_Object$rect(e),
					_user$project$Model_Object$rect(newObject));
			},
			list);
	});
var _user$project$Model_ObjectsOperation$island = F2(
	function (current, rest) {
		island:
		while (true) {
			var _p41 = A2(
				_elm_lang$core$List$partition,
				_user$project$Model_ObjectsOperation$linkedByAnyOf(current),
				rest);
			var newObjects = _p41._0;
			var rest$ = _p41._1;
			if (_elm_lang$core$List$isEmpty(newObjects)) {
				return A2(_elm_lang$core$Basics_ops['++'], current, newObjects);
			} else {
				var _v18 = A2(_elm_lang$core$Basics_ops['++'], current, newObjects),
					_v19 = rest$;
				current = _v18;
				rest = _v19;
				continue island;
...
var _user$project$Model_ObjectsOperation$rectFloat = function (e) {
	var _p42 = _user$project$Model_Object$rect(e);
	var x = _p42._0;
	var y = _p42._1;
	var w = _p42._2;
	var h = _p42._3;
	return {
		...
		_2: _elm_lang$core$Basics$toFloat(w),
		_3: _elm_lang$core$Basics$toFloat(h)
	};
};
var _user$project$Model_ObjectsOperation$center = function (e) {
	var _p43 = _user$project$Model_ObjectsOperation$rectFloat(e);
	var x = _p43._0;
	var y = _p43._1;
	var w = _p43._2;
	var h = _p43._3;
...
var _user$project$Model_ObjectsOperation$compareBy = F3(
	function (direction, from, $new) {
		var _p44 = _user$project$Model_ObjectsOperation$center($new);
		var newCenterX = _p44._0;
		var newCenterY = _p44._1;
		var _p45 = _user$project$Model_ObjectsOperation$center(from);
		var centerX = _p45._0;
		var centerY = _p45._1;
		if (_elm_lang$core$Native_Utils.eq(
			{ctor: '_Tuple2', _0: centerX, _1: centerY},
			...
			var greater = function () {
				...
				switch (_p46.ctor) {
					case 'Up':
						return (_elm_lang$core$Native_Utils.cmp(newCenterX, centerX) < 0) || (_elm_lang$core$Native_Utils.eq(newCenterX, centerX) && (_elm_lang$core$Native_Utils.cmp(newCenterY, centerY) < 0));
					case 'Down':
						return (_elm_lang$core$Native_Utils.cmp(newCenterX, centerX) > 0) || (_elm_lang$core$Native_Utils.eq(newCenterX, centerX) && (_elm_lang$core$Native_Utils.cmp(newCenterY, centerY) > 0));
					case 'Left':
						return (_elm_lang$core$Native_Utils.cmp(newCenterY, centerY) < 0) || (_elm_lang$core$Native_Utils.eq(newCenterY, centerY) && (_elm_lang$core$Native_Utils.cmp(newCenterX, centerX) < 0));
					default:
						return (_elm_lang$core$Native_Utils.cmp(newCenterY, centerY) > 0) || (_elm_lang$core$Native_Utils.eq(newCenterY, centerY) && (_elm_lang$core$Native_Utils.cmp(newCenterX, centerX) > 0));
				}
			}();
			return greater ? _elm_lang$core$Basics$GT : _elm_lang$core$Basics$LT;
		}
	});
var _user$project$Model_ObjectsOperation$lessBy = F3(
	function (direction, from, $new) {
		return _elm_lang$core$Native_Utils.eq(
			A3(_user$project$Model_ObjectsOperation$compareBy, direction, from, $new),
			_elm_lang$core$Basics$LT);
	});
var _user$project$Model_ObjectsOperation$minimumBy = F2(
	function (direction, list) {
		var f = F2(
			function (e1, memo) {
				var _p47 = memo;
				if (_p47.ctor === 'Just') {
					var _p48 = _p47._0;
					return A3(_user$project$Model_ObjectsOperation$lessBy, direction, _p48, e1) ? _elm_lang$core$Maybe$Just(e1) : _elm_lang$core$Maybe$Just(_p48);
				} else {
					return _elm_lang$core$Maybe$Just(e1);
				}
			});
		return A3(_elm_lang$core$List$foldl, f, _elm_lang$core$Maybe$Nothing, list);
	});
var _user$project$Model_ObjectsOperation$greaterBy = F3(
	function (direction, from, $new) {
		return _elm_lang$core$Native_Utils.eq(
			A3(_user$project$Model_ObjectsOperation$compareBy, direction, from, $new),
			_elm_lang$core$Basics$GT);
	});
var _user$project$Model_ObjectsOperation$filterCandidate = F3(
	function (direction, from, $new) {
		return A3(_user$project$Model_ObjectsOperation$greaterBy, direction, from, $new);
	});
var _user$project$Model_ObjectsOperation$nearest = F3(
	function (direction, from, list) {
		var filtered = A2(
			_elm_lang$core$List$filter,
			A2(_user$project$Model_ObjectsOperation$filterCandidate, direction, from),
			list);
		return _elm_lang$core$List$isEmpty(filtered) ? A2(_user$project$Model_ObjectsOperation$minimumBy, direction, list) : A2(_user$project$Model_ObjectsOperation$minimumBy, direction, filtered);
	});
var _user$project$Model_ObjectsOperation$withinRect = F3(
	function (_p50, _p49, list) {
		var _p51 = _p50;
		var _p52 = _p49;
		var isContained = function (e) {
			var _p53 = _user$project$Model_ObjectsOperation$center(e);
			var centerX = _p53._0;
			var centerY = _p53._1;
			return (_elm_lang$core$Native_Utils.cmp(centerX, _p51._0) > -1) && ((_elm_lang$core$Native_Utils.cmp(centerX, _p52._0) < 1) && ((_elm_lang$core$Native_Utils.cmp(centerY, _p51._1) > -1) && (_elm_lang$core$Native_Utils.cmp(centerY, _p52._1) < 1)));
		};
		return A2(_elm_lang$core$List$filter, isContained, list);
	});
var _user$project$Model_ObjectsOperation$withinRange = F2(
	function (range, list) {
		var _p54 = range;
		var start = _p54._0;
		var end = _p54._1;
		var _p55 = _user$project$Model_ObjectsOperation$center(start);
		var startX = _p55._0;
		var startY = _p55._1;
		var _p56 = _user$project$Model_ObjectsOperation$center(end);
		var endX = _p56._0;
		var endY = _p56._1;
		var left = A2(_elm_lang$core$Basics$min, startX, endX);
		var right = A2(_elm_lang$core$Basics$max, startX, endX);
		var top = A2(_elm_lang$core$Basics$min, startY, endY);
		var bottom = A2(_elm_lang$core$Basics$max, startY, endY);
		return A3(
			_user$project$Model_ObjectsOperation$withinRect,
			{ctor: '_Tuple2', _0: left, _1: top},
			{ctor: '_Tuple2', _0: right, _1: bottom},
			list);
	});
var _user$project$Model_ObjectsOperation$Down = {ctor: 'Down'};
var _user$project$Model_ObjectsOperation$Right = {ctor: 'Right'};
var _user$project$Model_ObjectsOperation$Left = {ctor: 'Left'};
var _user$project$Model_ObjectsOperation$Up = {ctor: 'Up'};
var _user$project$Model_ObjectsOperation$opposite = function (direction) {
	var _p57 = direction;
	switch (_p57.ctor) {
		case 'Left':
			return _user$project$Model_ObjectsOperation$Right;
		case 'Right':
			return _user$project$Model_ObjectsOperation$Left;
		case 'Up':
			return _user$project$Model_ObjectsOperation$Down;
		default:
			return _user$project$Model_ObjectsOperation$Up;
	}
};
var _user$project$Model_ObjectsOperation$expandOrShrink = F4(
	function (direction, primary, current, all) {
		var _p58 = _user$project$Model_Object$rect(primary);
		var left0 = _p58._0;
		var top0 = _p58._1;
		var w0 = _p58._2;
		var h0 = _p58._3;
		...
		var _p59 = A2(
			...
			_user$project$Model_ObjectsOperation$bounds(current));
		var left = _p59._0;
		var top = _p59._1;
		var right = _p59._2;
		var bottom = _p59._3;
		var isExpand = function () {
			...
			switch (_p60.ctor) {
				case 'Up':
					return _elm_lang$core$Native_Utils.eq(bottom, bottom0) && (_elm_lang$core$Native_Utils.cmp(top, top0) < 1);
				case 'Down':
					return _elm_lang$core$Native_Utils.eq(top, top0) && (_elm_lang$core$Native_Utils.cmp(bottom, bottom0) > -1);
				case 'Left':
					return _elm_lang$core$Native_Utils.eq(right, right0) && (_elm_lang$core$Native_Utils.cmp(left, left0) < 1);
				default:
					return _elm_lang$core$Native_Utils.eq(left, left0) && (_elm_lang$core$Native_Utils.cmp(right, right0) > -1);
			}
		}();
		if (isExpand) {
			var filter = function (e1) {
				var _p61 = _user$project$Model_Object$rect(e1);
				var left1 = _p61._0;
				var top1 = _p61._1;
				var w1 = _p61._2;
				var h1 = _p61._3;
				...
				switch (_p62.ctor) {
					case 'Up':
						return (_elm_lang$core$Native_Utils.cmp(left1, left) > -1) && ((_elm_lang$core$Native_Utils.cmp(right1, right) < 1) && (_elm_lang$core$Native_Utils.cmp(top1, top) < 0));
					case 'Down':
						return (_elm_lang$core$Native_Utils.cmp(left1, left) > -1) && ((_elm_lang$core$Native_Utils.cmp(right1, right) < 1) && (_elm_lang$core$Native_Utils.cmp(bottom1, bottom) > 0));
					case 'Left':
						return (_elm_lang$core$Native_Utils.cmp(top1, top) > -1) && ((_elm_lang$core$Native_Utils.cmp(bottom1, bottom) < 1) && (_elm_lang$core$Native_Utils.cmp(left1, left) < 0));
					default:
						return (_elm_lang$core$Native_Utils.cmp(top1, top) > -1) && ((_elm_lang$core$Native_Utils.cmp(bottom1, bottom) < 1) && (_elm_lang$core$Native_Utils.cmp(right1, right) > 0));
				}
			};
			var filtered = A2(_elm_lang$core$List$filter, filter, all);
			return A2(
				_elm_lang$core$Basics_ops['++'],
				current,
				A2(_user$project$Model_ObjectsOperation$minimumPartsOf, direction, filtered));
		} else {
			return A2(
				_user$project$Model_ObjectsOperation$restOfMaximumPartsOf,
				_user$project$Model_ObjectsOperation$opposite(direction),
				current);
		}
	});

var _user$project$Model_Floor$src = function (floor) {
	var _p0 = floor.image;
	if (_p0.ctor === 'Just') {
		return _elm_lang$core$Maybe$Just(
			A2(_elm_lang$core$Basics_ops['++'], '/images/floors/', _p0._0));
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Model_Floor$setImage$ = F4(
	function (url, width, height, floor) {
		return _elm_lang$core$Native_Utils.update(
			floor,
			{
				width: width,
				height: height,
				image: _elm_lang$core$Maybe$Just(url)
			});
	});
var _user$project$Model_Floor$setObjects = F2(
	function (objects, floor) {
		return _elm_lang$core$Native_Utils.update(
			floor,
			{objects: objects});
	});
var _user$project$Model_Floor$addObjects = F2(
	function (objects, floor) {
		return A2(
			_user$project$Model_Floor$setObjects,
			A2(_elm_lang$core$Basics_ops['++'], floor.objects, objects),
			floor);
	});
var _user$project$Model_Floor$objects = function (floor) {
	return floor.objects;
};
var _user$project$Model_Floor$name = function (floor) {
	return floor.name;
};
var _user$project$Model_Floor$pixelToReal = function (pixel) {
	return _elm_lang$core$Basics$floor(
		_elm_lang$core$Basics$toFloat(pixel) / 80);
};
var _user$project$Model_Floor$realSize = function (floor) {
	var _p1 = floor.realSize;
	if (_p1.ctor === 'Just') {
		return {ctor: '_Tuple2', _0: _p1._0._0, _1: _p1._0._1};
	} else {
		return {
			ctor: '_Tuple2',
			_0: _user$project$Model_Floor$pixelToReal(floor.width),
			_1: _user$project$Model_Floor$pixelToReal(floor.height)
		};
	}
};
var _user$project$Model_Floor$realToPixel = function (real) {
	return _elm_lang$core$Basics$floor(
		_elm_lang$core$Basics$toFloat(real) * 80);
};
var _user$project$Model_Floor$size = function (floor) {
	var _p2 = floor.realSize;
	if (_p2.ctor === 'Just') {
		return {
			ctor: '_Tuple2',
			_0: _user$project$Model_Floor$realToPixel(_p2._0._0),
			_1: _user$project$Model_Floor$realToPixel(_p2._0._1)
		};
	} else {
		return {ctor: '_Tuple2', _0: floor.width, _1: floor.height};
	}
};
var _user$project$Model_Floor$width = function (floor) {
	return _elm_lang$core$Basics$fst(
		_user$project$Model_Floor$size(floor));
};
var _user$project$Model_Floor$height = function (floor) {
	return _elm_lang$core$Basics$snd(
		_user$project$Model_Floor$size(floor));
};
var _user$project$Model_Floor$update = F2(
	function (msg, floor) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'CreateDesk':
				var create = function (_p4) {
					var _p5 = _p4;
					return A6(
						_user$project$Model_Object$initDesk,
						_p5._0,
						{ctor: '_Tuple4', _0: _p5._1._0, _1: _p5._1._1, _2: _p5._1._2, _3: _p5._1._3},
						_p5._2,
						_p5._3,
						_p5._4,
						_elm_lang$core$Maybe$Nothing);
				...
				return A2(
					_user$project$Model_Floor$addObjects,
					A2(_elm_lang$core$List$map, create, _p3._0),
					floor);
			case 'CreateLabel':
				var create = function (_p6) {
					var _p7 = _p6;
					return A7(
						_user$project$Model_Object$initLabel,
						_p7._0,
						{ctor: '_Tuple4', _0: _p7._1._0, _1: _p7._1._1, _2: _p7._1._2, _3: _p7._1._3},
						_p7._2,
						_p7._3,
						_p7._4,
						_p7._5,
						_user$project$Model_Object$Rectangle);
				};
				return A2(
					_user$project$Model_Floor$addObjects,
					A2(_elm_lang$core$List$map, create, _p3._0),
			...
			case 'Move':
				return A2(
					_user$project$Model_Floor$setObjects,
					A4(
						_user$project$Model_ObjectsOperation$moveObjects,
						_p3._1,
						{ctor: '_Tuple2', _0: _p3._2._0, _1: _p3._2._1},
						_p3._0,
						_user$project$Model_Floor$objects(floor)),
					floor);
			case 'Paste':
				return A2(
					_user$project$Model_Floor$setObjects,
					A2(
						...
						floor.objects,
						A3(
							_user$project$Model_ObjectsOperation$pasteObjects,
			...
			case 'RotateObject':
				return A2(
					...
					A3(
						_user$project$Model_ObjectsOperation$partiallyChange,
						_user$project$Model_Object$rotate,
						_elm_lang$core$Native_List.fromArray(
							[_p3._0]),
						_user$project$Model_Floor$objects(floor)),
					floor);
			case 'ChangeId':
				return _elm_lang$core$Native_Utils.update(
					floor,
					{id: _p3._0});
			case 'ChangeObjectBackgroundColor':
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$changeBackgroundColor(_p3._1),
					_p3._0,
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
			case 'ChangeObjectColor':
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$changeColor(_p3._1),
					_p3._0,
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
			case 'ChangeObjectShape':
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$changeShape(_p3._1),
					_p3._0,
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
			case 'ChangeObjectName':
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$changeName(_p3._1),
					_p3._0,
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
			case 'ChangeObjectFontSize':
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$changeFontSize(_p3._1),
					_p3._0,
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
			case 'ToFirstNameOnly':
				var change = function (name) {
					var _p8 = _elm_lang$core$String$words(name);
					if (_p8.ctor === '[]') {
						return '';
					} else {
						return _p8._0;
				...
				var newObjects = A3(
					...
					function (e) {
						return A3(
							...
							_user$project$Model_Object$changeName,
							e,
							change(
								_user$project$Model_Object$nameOf(e)));
					},
					_p3._0,
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
			...
			case 'ResizeObject':
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$changeSize(_p3._1),
					_elm_lang$core$Native_List.fromArray(
						[_p3._0]),
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
			...
			case 'ChangeOrd':
				return _elm_lang$core$Native_Utils.update(
					...
					{ord: _p3._0});
			case 'SetImage':
				return A4(_user$project$Model_Floor$setImage$, _p3._0, _p3._1, _p3._2, floor);
			case 'ChangeRealSize':
				return _elm_lang$core$Native_Utils.update(
					floor,
					{
						realSize: _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple2', _0: _p3._0._0, _1: _p3._0._1})
					});
			case 'SetPerson':
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$setPerson(
			...
			case 'SetPeople':
				var f = F2(
					function (_p10, objects) {
						var _p11 = _p10;
						return A3(
							_user$project$Model_ObjectsOperation$partiallyChange,
							_user$project$Model_Object$setPerson(
								_elm_lang$core$Maybe$Just(_p11._1)),
							_elm_lang$core$Native_List.fromArray(
								[_p11._0]),
							objects);
					});
			...
			default:
				var newObjects = A3(
					_user$project$Model_ObjectsOperation$partiallyChange,
					_user$project$Model_Object$setPerson(_elm_lang$core$Maybe$Nothing),
					_elm_lang$core$Native_List.fromArray(
						[_p3._0]),
					_user$project$Model_Floor$objects(floor));
				return A2(_user$project$Model_Floor$setObjects, newObjects, floor);
...
var _user$project$Model_Floor$copy = F2(
	function (id, floor) {
		return _elm_lang$core$Native_Utils.update(
			floor,
			{
				id: id,
				version: 0,
				name: A2(_elm_lang$core$Basics_ops['++'], 'Copy of ', floor.name),
				$public: false,
				update: _elm_lang$core$Maybe$Nothing
			});
	});
var _user$project$Model_Floor$init = function (id) {
	return {
		id: id,
		version: 0,
		name: 'New Floor',
		...
		width: 800,
		height: 600,
		realSize: _elm_lang$core$Maybe$Nothing,
		image: _elm_lang$core$Maybe$Nothing,
		$public: false,
		update: _elm_lang$core$Maybe$Nothing
	};
};
var _user$project$Model_Floor$empty = _user$project$Model_Floor$init('');
var _user$project$Model_Floor$initWithOrder = F2(
	function (id, ord) {
		var floor = _user$project$Model_Floor$init(id);
		return _elm_lang$core$Native_Utils.update(
			floor,
			{ord: ord});
	});
var _user$project$Model_Floor$FloorBase = F5(
	function (a, b, c, d, e) {
		return {id: a, version: b, name: c, ord: d, $public: e};
	});
var _user$project$Model_Floor$baseOf = function (_p12) {
	var _p13 = _p12;
	return A5(_user$project$Model_Floor$FloorBase, _p13.id, _p13.version, _p13.name, _p13.ord, _p13.$public);
};
var _user$project$Model_Floor$UnsetPerson = function (a) {
	return {ctor: 'UnsetPerson', _0: a};
};
var _user$project$Model_Floor$unsetPerson = _user$project$Model_Floor$UnsetPerson;
var _user$project$Model_Floor$SetPeople = function (a) {
	return {ctor: 'SetPeople', _0: a};
};
var _user$project$Model_Floor$setPeople = _user$project$Model_Floor$SetPeople;
var _user$project$Model_Floor$SetPerson = F2(
	function (a, b) {
		return {ctor: 'SetPerson', _0: a, _1: b};
	});
var _user$project$Model_Floor$setPerson = _user$project$Model_Floor$SetPerson;
var _user$project$Model_Floor$ChangeRealSize = function (a) {
	return {ctor: 'ChangeRealSize', _0: a};
};
var _user$project$Model_Floor$changeRealSize = _user$project$Model_Floor$ChangeRealSize;
var _user$project$Model_Floor$SetImage = F3(
	function (a, b, c) {
		return {ctor: 'SetImage', _0: a, _1: b, _2: c};
	});
var _user$project$Model_Floor$setImage = _user$project$Model_Floor$SetImage;
var _user$project$Model_Floor$ChangeOrd = function (a) {
	return {ctor: 'ChangeOrd', _0: a};
};
var _user$project$Model_Floor$changeOrd = _user$project$Model_Floor$ChangeOrd;
var _user$project$Model_Floor$ChangeName = function (a) {
	return {ctor: 'ChangeName', _0: a};
};
var _user$project$Model_Floor$changeName = _user$project$Model_Floor$ChangeName;
var _user$project$Model_Floor$ResizeObject = F2(
	function (a, b) {
		return {ctor: 'ResizeObject', _0: a, _1: b};
	});
var _user$project$Model_Floor$resizeObject = _user$project$Model_Floor$ResizeObject;
var _user$project$Model_Floor$RemoveSpaces = function (a) {
	return {ctor: 'RemoveSpaces', _0: a};
};
var _user$project$Model_Floor$removeSpaces = _user$project$Model_Floor$RemoveSpaces;
var _user$project$Model_Floor$ToFirstNameOnly = function (a) {
	return {ctor: 'ToFirstNameOnly', _0: a};
};
var _user$project$Model_Floor$toFirstNameOnly = _user$project$Model_Floor$ToFirstNameOnly;
var _user$project$Model_Floor$ChangeObjectFontSize = F2(
	function (a, b) {
		return {ctor: 'ChangeObjectFontSize', _0: a, _1: b};
	});
var _user$project$Model_Floor$changeObjectFontSize = _user$project$Model_Floor$ChangeObjectFontSize;
var _user$project$Model_Floor$ChangeObjectName = F2(
	function (a, b) {
		return {ctor: 'ChangeObjectName', _0: a, _1: b};
	});
var _user$project$Model_Floor$changeObjectName = _user$project$Model_Floor$ChangeObjectName;
var _user$project$Model_Floor$ChangeObjectShape = F2(
	function (a, b) {
		return {ctor: 'ChangeObjectShape', _0: a, _1: b};
	});
var _user$project$Model_Floor$changeObjectShape = _user$project$Model_Floor$ChangeObjectShape;
var _user$project$Model_Floor$ChangeObjectColor = F2(
	function (a, b) {
		return {ctor: 'ChangeObjectColor', _0: a, _1: b};
	});
var _user$project$Model_Floor$changeObjectColor = _user$project$Model_Floor$ChangeObjectColor;
var _user$project$Model_Floor$ChangeObjectBackgroundColor = F2(
	function (a, b) {
		return {ctor: 'ChangeObjectBackgroundColor', _0: a, _1: b};
	});
var _user$project$Model_Floor$changeObjectBackgroundColor = _user$project$Model_Floor$ChangeObjectBackgroundColor;
var _user$project$Model_Floor$ChangeId = function (a) {
	return {ctor: 'ChangeId', _0: a};
};
var _user$project$Model_Floor$changeId = _user$project$Model_Floor$ChangeId;
var _user$project$Model_Floor$RotateObject = function (a) {
	return {ctor: 'RotateObject', _0: a};
};
var _user$project$Model_Floor$rotateObject = _user$project$Model_Floor$RotateObject;
var _user$project$Model_Floor$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$Model_Floor$delete = _user$project$Model_Floor$Delete;
var _user$project$Model_Floor$Paste = F2(
	function (a, b) {
		return {ctor: 'Paste', _0: a, _1: b};
	});
var _user$project$Model_Floor$paste = _user$project$Model_Floor$Paste;
var _user$project$Model_Floor$Move = F3(
	function (a, b, c) {
		return {ctor: 'Move', _0: a, _1: b, _2: c};
	});
var _user$project$Model_Floor$move = _user$project$Model_Floor$Move;
var _user$project$Model_Floor$CreateLabel = function (a) {
	return {ctor: 'CreateLabel', _0: a};
};
var _user$project$Model_Floor$createLabel = _user$project$Model_Floor$CreateLabel;
var _user$project$Model_Floor$CreateDesk = function (a) {
	return {ctor: 'CreateDesk', _0: a};
};
var _user$project$Model_Floor$createDesk = _user$project$Model_Floor$CreateDesk;

var _user$project$Model_FloorDiff$diffObject = F2(
	function ($new, old) {
		var relatedPersonChange = (!_elm_lang$core$Native_Utils.eq(
			_user$project$Model_Object$relatedPerson($new),
			_user$project$Model_Object$relatedPerson(old))) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'person chaged: ',
				A2(
					...
					_elm_lang$core$Basics$toString(
						_user$project$Model_Object$relatedPerson(old)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' -> ',
						_elm_lang$core$Basics$toString(
							_user$project$Model_Object$relatedPerson($new)))))) : _elm_lang$core$Maybe$Nothing;
		var shapeChange = (!_elm_lang$core$Native_Utils.eq(
			_user$project$Model_Object$shapeOf($new),
			_user$project$Model_Object$shapeOf(old))) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'shape chaged: ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(
						_user$project$Model_Object$shapeOf(old)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' -> ',
						_elm_lang$core$Basics$toString(
							_user$project$Model_Object$shapeOf($new)))))) : _elm_lang$core$Maybe$Nothing;
		var fontSizeChange = (!_elm_lang$core$Native_Utils.eq(
			_user$project$Model_Object$fontSizeOf($new),
			_user$project$Model_Object$fontSizeOf(old))) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'font size chaged: ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(
						_user$project$Model_Object$fontSizeOf(old)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' -> ',
						_elm_lang$core$Basics$toString(
							_user$project$Model_Object$fontSizeOf($new)))))) : _elm_lang$core$Maybe$Nothing;
		var colorChange = (!_elm_lang$core$Native_Utils.eq(
			_user$project$Model_Object$colorOf($new),
			_user$project$Model_Object$colorOf(old))) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'color chaged: ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Model_Object$colorOf(old),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' -> ',
						_user$project$Model_Object$colorOf($new))))) : _elm_lang$core$Maybe$Nothing;
		var bgColorChange = (!_elm_lang$core$Native_Utils.eq(
			_user$project$Model_Object$backgroundColorOf($new),
			_user$project$Model_Object$backgroundColorOf(old))) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'background color chaged: ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Model_Object$backgroundColorOf(old),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' -> ',
						_user$project$Model_Object$backgroundColorOf($new))))) : _elm_lang$core$Maybe$Nothing;
		var sizeChange = (!_elm_lang$core$Native_Utils.eq(
			_user$project$Model_Object$rect($new),
			_user$project$Model_Object$rect(old))) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'position/size chaged: ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(
						_user$project$Model_Object$rect(old)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' -> ',
						_elm_lang$core$Basics$toString(
							_user$project$Model_Object$rect($new)))))) : _elm_lang$core$Maybe$Nothing;
		var nameChange = (!_elm_lang$core$Native_Utils.eq(
			_user$project$Model_Object$nameOf($new),
			_user$project$Model_Object$nameOf(old))) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'name chaged: ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Model_Object$nameOf(old),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' -> ',
						_user$project$Model_Object$nameOf($new))))) : _elm_lang$core$Maybe$Nothing;
		return A2(
			_elm_lang$core$List$filterMap,
			_elm_lang$core$Basics$identity,
			_elm_lang$core$Native_List.fromArray(
				[nameChange, sizeChange, bgColorChange, colorChange, fontSizeChange, shapeChange, relatedPersonChange]));
	});
var _user$project$Model_FloorDiff$diffObjects = F2(
	function (newObjects, oldObjects) {
		var f = F2(
			function ($new, _p0) {
				var _p1 = _p0;
				var _p7 = _p1._2;
				...
				var _p2 = A2(
					...
					_user$project$Model_Object$idOf($new),
					_p6);
				if (_p2.ctor === 'Just') {
					var _p4 = _p2._0;
					return {
						...
						_1: _p5,
						_2: function () {
							var _p3 = A2(_user$project$Model_FloorDiff$diffObject, $new, _p4);
							if (_p3.ctor === '[]') {
								return _p7;
							} else {
								return A2(
									_elm_lang$core$List_ops['::'],
									{$new: $new, old: _p4, changes: _p3},
									_p7);
							}
						}()
					};
					...
					return {
						ctor: '_Tuple3',
						_0: _p6,
						_1: A2(_elm_lang$core$List_ops['::'], $new, _p5),
						_2: _p7
					};
				}
			});
		var oldDict = _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (obj) {
					return {
						ctor: '_Tuple2',
						_0: _user$project$Model_Object$idOf(obj),
						_1: obj
					};
				},
				oldObjects));
		var _p8 = A3(
			...
			newObjects);
		var ramainingOldDict = _p8._0;
		var add = _p8._1;
		var modify = _p8._2;
		var $delete = _elm_lang$core$Dict$values(ramainingOldDict);
		return {added: add, modified: modify, deleted: $delete};
	});
var _user$project$Model_FloorDiff$propertyChangesHelp = F2(
	function (current, prev) {
		var imageChange = (!_elm_lang$core$Native_Utils.eq(current.image, prev.image)) ? _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple3',
				_0: 'Image',
				_1: A2(_elm_lang$core$Maybe$withDefault, '', current.image),
				_2: A2(_elm_lang$core$Maybe$withDefault, '', prev.image)
			}
			]) : _elm_lang$core$Native_List.fromArray(
			[]);
		var sizeChange = function () {
			if (_elm_lang$core$Native_Utils.eq(current.realSize, prev.realSize)) {
				return _elm_lang$core$Native_List.fromArray(
					[]);
			} else {
				var _p9 = {ctor: '_Tuple2', _0: current.realSize, _1: prev.realSize};
				_v3_3:
				do {
					if (_p9.ctor === '_Tuple2') {
						if (_p9._0.ctor === 'Just') {
							if (_p9._0._0.ctor === '_Tuple2') {
								if (_p9._1.ctor === 'Just') {
									if (_p9._1._0.ctor === '_Tuple2') {
										return _elm_lang$core$Native_List.fromArray(
											[
												{
												ctor: '_Tuple3',
												...
												_1: A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(_p9._0._0._0),
														A2(
															_elm_lang$core$Basics_ops['++'],
															', ',
															A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(_p9._0._0._1),
																')')))),
												_2: A2(
													_elm_lang$core$Basics_ops['++'],
													'(',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(_p9._1._0._0),
														A2(
															_elm_lang$core$Basics_ops['++'],
															', ',
															A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(_p9._1._0._1),
																')'))))
											}
											]);
									} else {
							...
							if ((_p9._1.ctor === 'Just') && (_p9._1._0.ctor === '_Tuple2')) {
								return _elm_lang$core$Native_List.fromArray(
									[
										{
										ctor: '_Tuple3',
		...
		var ordChange = _elm_lang$core$Native_Utils.eq(current.ord, prev.ord) ? _elm_lang$core$Native_List.fromArray(
			[]) : _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple3',
				_0: 'Order',
				_1: _elm_lang$core$Basics$toString(current.ord),
				_2: _elm_lang$core$Basics$toString(prev.ord)
			}
			]);
		var nameChange = _elm_lang$core$Native_Utils.eq(
			_user$project$Model_Floor$name(current),
			_user$project$Model_Floor$name(prev)) ? _elm_lang$core$Native_List.fromArray(
			[]) : _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple3',
				_0: 'Name',
				_1: _user$project$Model_Floor$name(current),
				_2: _user$project$Model_Floor$name(prev)
			}
			]);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				ordChange,
				A2(_elm_lang$core$Basics_ops['++'], sizeChange, imageChange)));
	});
var _user$project$Model_FloorDiff$diffPropertyChanges = F2(
	function (current, prev) {
		var _p10 = prev;
		if (_p10.ctor === 'Just') {
			return A2(_user$project$Model_FloorDiff$propertyChangesHelp, current, _p10._0);
		} else {
			return A2(
				_elm_lang$core$Basics_ops['++'],
								...
								_1: A2(
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(_p11._0._1),
												')')))),
								_2: ''
							}
							]);
...
var _user$project$Model_FloorDiff$diff = F2(
	function (current, prev) {
		var oldObjects = A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(_elm_lang$core$Maybe$map, _user$project$Model_Floor$objects, prev));
		var newObjects = _user$project$Model_Floor$objects(current);
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Model_FloorDiff$diffPropertyChanges, current, prev),
			_1: A2(_user$project$Model_FloorDiff$diffObjects, newObjects, oldObjects)
		};
	});
var _user$project$Model_FloorDiff$noObjectsChange = {
	added: _elm_lang$core$Native_List.fromArray(
		[]),
	modified: _elm_lang$core$Native_List.fromArray(
		[]),
	deleted: _elm_lang$core$Native_List.fromArray(
		[])
};
var _user$project$Model_FloorDiff$Options = F3(
	function (a, b, c) {
		return {onClose: a, onConfirm: b, noOp: c};
	});
var _user$project$Model_FloorDiff$ObjectModification = F3(
	function (a, b, c) {
		return {$new: a, old: b, changes: c};
	});
var _user$project$Model_FloorDiff$ObjectsChange = F3(
	function (a, b, c) {
		return {added: a, modified: b, deleted: c};
	});

var _user$project$Model_FloorInfo$idOf = function (info) {
	var _p0 = info;
	switch (_p0.ctor) {
		case 'Public':
			return _p0._0.id;
...
var _user$project$Model_FloorInfo$findViewingFloor = F2(
	function (floorId, list) {
		var _p1 = A2(
			_elm_lang$core$List$filter,
			function (info) {
				return _elm_lang$core$Native_Utils.eq(
					_user$project$Model_FloorInfo$idOf(info),
					floorId);
			},
			list);
		if (_p1.ctor === '::') {
...
var _user$project$Model_FloorInfo$findFloor = F3(
	function (floorId, version, list) {
		var _p3 = A2(
			_elm_lang$core$List$filter,
			function (info) {
				return _elm_lang$core$Native_Utils.eq(
		...
		if (_p3.ctor === '::') {
			...
			switch (_p4.ctor) {
				case 'Public':
					var _p5 = _p4._0;
					return _elm_lang$core$Native_Utils.eq(_p5.version, version) ? _elm_lang$core$Maybe$Just(_p5) : _elm_lang$core$Maybe$Nothing;
				case 'PublicWithEdit':
					var _p7 = _p4._0;
					var _p6 = _p4._1;
					return _elm_lang$core$Native_Utils.eq(_p7.version, version) ? _elm_lang$core$Maybe$Just(_p7) : (_elm_lang$core$Native_Utils.eq(_p6.version, version) ? _elm_lang$core$Maybe$Just(_p6) : _elm_lang$core$Maybe$Nothing);
				default:
					var _p8 = _p4._0;
					return _elm_lang$core$Native_Utils.eq(_p8.version, version) ? _elm_lang$core$Maybe$Just(_p8) : _elm_lang$core$Maybe$Nothing;
			}
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Model_FloorInfo$Private = function (a) {
	return {ctor: 'Private', _0: a};
};
var _user$project$Model_FloorInfo$PublicWithEdit = F2(
	function (a, b) {
		return {ctor: 'PublicWithEdit', _0: a, _1: b};
	});
var _user$project$Model_FloorInfo$Public = function (a) {
	return {ctor: 'Public', _0: a};
};
var _user$project$Model_FloorInfo$addNewFloor = F2(
	function (newFloor, list) {
		var _p9 = list;
		if (_p9.ctor === '[]') {
			return _elm_lang$core$Native_List.fromArray(
				[
					newFloor.$public ? _user$project$Model_FloorInfo$Public(newFloor) : _user$project$Model_FloorInfo$Private(newFloor)
				]);
		} else {
			var _p12 = _p9._1;
			var _p11 = _p9._0;
			if (_elm_lang$core$Native_Utils.eq(
				_user$project$Model_FloorInfo$idOf(_p11),
				newFloor.id)) {
				var newInfo = function () {
					var _p10 = _p11;
					switch (_p10.ctor) {
						case 'Public':
							return newFloor.$public ? _user$project$Model_FloorInfo$Public(newFloor) : A2(_user$project$Model_FloorInfo$PublicWithEdit, _p10._0, newFloor);
						case 'PublicWithEdit':
							return newFloor.$public ? _user$project$Model_FloorInfo$Public(newFloor) : A2(_user$project$Model_FloorInfo$PublicWithEdit, _p10._0, newFloor);
						default:
							return newFloor.$public ? _user$project$Model_FloorInfo$Public(newFloor) : _user$project$Model_FloorInfo$Private(newFloor);
					}
				}();
				return A2(_elm_lang$core$List_ops['::'], newInfo, _p12);
			} else {
				return A2(
					_elm_lang$core$List_ops['::'],
					_p11,
					A2(_user$project$Model_FloorInfo$addNewFloor, newFloor, _p12));
			}
		}
	});

var _user$project$Model_User$isAdmin = function (user) {
	var _p0 = user;
	if (_p0.ctor === 'Admin') {
		return true;
	} else {
...
var _user$project$Model_User$Guest = {ctor: 'Guest'};
var _user$project$Model_User$isGuest = function (user) {
	return _elm_lang$core$Native_Utils.eq(user, _user$project$Model_User$Guest);
};
var _user$project$Model_User$guest = _user$project$Model_User$Guest;
var _user$project$Model_User$General = function (a) {
	return {ctor: 'General', _0: a};
};
var _user$project$Model_User$general = function (person) {
	return _user$project$Model_User$General(person);
};
var _user$project$Model_User$Admin = function (a) {
	return {ctor: 'Admin', _0: a};
};
var _user$project$Model_User$admin = function (person) {
	return _user$project$Model_User$Admin(person);
};

var _user$project$Model_Prototype$Prototype = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, name: b, color: c, backgroundColor: d, size: e, fontSize: f, shape: g};
	});

var _user$project$Model_SearchResult$reorderResults = F2(
	function (thisFloorId, results) {
		var _p0 = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p2, _p1) {
					...
					var _p7 = _p4._1;
					var _p6 = _p4._2;
					var _p5 = _p3.objectIdAndFloorId;
					if (_p5.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(
							_elm_lang$core$Maybe$Just(_p5._0._1),
							thisFloorId) ? {
							ctor: '_Tuple3',
							_0: A2(_elm_lang$core$List_ops['::'], _p9, _p8),
							_1: _p7,
							_2: _p6
						} : {
							ctor: '_Tuple3',
							_0: _p8,
							_1: A2(_elm_lang$core$List_ops['::'], _p9, _p7),
							_2: _p6
						};
					} else {
						return {
							...
							_0: _p8,
							_1: _p7,
							_2: A2(_elm_lang$core$List_ops['::'], _p9, _p6)
						};
					}
				}),
			{
			...
			results);
		var inThisFloor = _p0._0;
		var inOtherFloor = _p0._1;
		var missing = _p0._2;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			inThisFloor,
			A2(_elm_lang$core$Basics_ops['++'], inOtherFloor, missing));
	});
var _user$project$Model_SearchResult$SearchResult = F2(
	function (a, b) {
		return {personId: a, objectIdAndFloorId: b};
	});

var _user$project$Model_ColorPalette$init = function (entities) {
	var sorted = A2(
		...
		entities);
	var backgroundColors = A2(
		_elm_lang$core$List$filterMap,
		function (e) {
			return _elm_lang$core$Native_Utils.eq(e.type_, 'backgroundColor') ? _elm_lang$core$Maybe$Just(e.color) : _elm_lang$core$Maybe$Nothing;
		},
		sorted);
	var textColors = A2(
		_elm_lang$core$List$filterMap,
		function (e) {
			return _elm_lang$core$Native_Utils.eq(e.type_, 'color') ? _elm_lang$core$Maybe$Just(e.color) : _elm_lang$core$Maybe$Nothing;
		},
		sorted);
	return {backgroundColors: backgroundColors, textColors: textColors};
};
var _user$project$Model_ColorPalette$ColorPalette = F2(
	function (a, b) {
		return {backgroundColors: a, textColors: b};
	});
var _user$project$Model_ColorPalette$ColorEntity = F4(
	function (a, b, c, d) {
		return {id: a, ord: b, type_: c, color: d};
	});

var _user$project$Util_DecodeUtil$intSize = A3(
	...
	_elm_lang$core$Json_Decode$int);
var _user$project$Util_DecodeUtil_ops = _user$project$Util_DecodeUtil_ops || {};
_user$project$Util_DecodeUtil_ops['?='] = F2(
	function (key, decorder) {
		return _elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode_ops[':='], key, decorder));
	});
var _user$project$Util_DecodeUtil$optional$ = F2(
	function (field, decoder) {
		return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom(
			A2(_user$project$Util_DecodeUtil_ops['?='], field, decoder));
	});

var _user$project$API_Serialization$decodePrototype = A3(
						...
						A3(
							...
							A3(
								...
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
									F8(
										function (id, backgroundColor, color, name, width, height, fontSize, shape) {
											return {
												id: id,
												name: name,
												backgroundColor: backgroundColor,
												...
												fontSize: fontSize,
												shape: _elm_lang$core$Native_Utils.eq(shape, 'Ellipse') ? _user$project$Model_Object$Ellipse : _user$project$Model_Object$Rectangle
											};
										}))))))))));
var _user$project$API_Serialization$decodeFloorBase = A4(
		...
		A3(
			...
			A3(
				...
				A3(
					...
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
						F5(
							function (id, version, name, ord, $public) {
								return {id: id, version: version, name: name, ord: ord, $public: $public};
							})))))));
var _user$project$API_Serialization$decodeFloorInfo = A2(
	_elm_lang$core$Json_Decode$map,
	function (_p0) {
		var _p1 = _p0;
		var _p3 = _p1._1;
		var _p2 = _p1._0;
		return _p3.$public ? _user$project$Model_FloorInfo$Public(_p3) : (_p2.$public ? A2(_user$project$Model_FloorInfo$PublicWithEdit, _p2, _p3) : _user$project$Model_FloorInfo$Private(_p3));
	},
	A3(
		_elm_lang$core$Json_Decode$tuple2,
		F2(
		...
		_user$project$API_Serialization$decodeFloorBase,
		_user$project$API_Serialization$decodeFloorBase));
var _user$project$API_Serialization$decodeObject = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'shape',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A4(
			...
			'fontSize',
			_elm_lang$core$Json_Decode$float,
			_user$project$Model_Object$defaultFontSize,
			A3(
				_user$project$Util_DecodeUtil$optional$,
				'personId',
				_elm_lang$core$Json_Decode$string,
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
																						...
																						return function (fontSize) {
																							return function (color) {
																								return function (shape) {
																									return _elm_lang$core$Native_Utils.eq(tipe, 'desk') ? A6(
																										_user$project$Model_Object$initDesk,
																										id,
																										...
																										fontSize,
																										color,
																										_elm_lang$core$Native_Utils.eq(shape, 'rectangle') ? _user$project$Model_Object$Rectangle : _user$project$Model_Object$Ellipse);
																								};
																							};
																						};
																					};
...
var _user$project$API_Serialization$decodeSearchResult = A3(
	_user$project$Util_DecodeUtil$optional$,
	'objectIdAndFloorId',
	A3(
		_elm_lang$core$Json_Decode$tuple2,
		...
		_user$project$API_Serialization$decodeObject,
		_elm_lang$core$Json_Decode$string),
	A3(
		_user$project$Util_DecodeUtil$optional$,
		'personId',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model_SearchResult$SearchResult)));
var _user$project$API_Serialization$decodeSearchResults = _elm_lang$core$Json_Decode$list(_user$project$API_Serialization$decodeSearchResult);
var _user$project$API_Serialization$decodeFloor = A3(
	_user$project$Util_DecodeUtil$optional$,
	'updateAt',
	_elm_lang$core$Json_Decode$float,
	A3(
						...
						A3(
							...
							A3(
								...
								A3(
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
									'objects',
									_elm_lang$core$Json_Decode$list(_user$project$API_Serialization$decodeObject),
									A3(
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
										'ord',
										_elm_lang$core$Json_Decode$int,
																...
																return function (name) {
																	return function (ord) {
																		return function (objects) {
																			return function (width) {
																				return function (height) {
																					return function (realWidth) {
																						return function (realHeight) {
																							return function (image) {
																								return function ($public) {
																									return function (updateBy) {
																												...
																												update: A3(
																													...
																													F2(
																														function (by, at) {
																															return {
																																by: by,
																																at: _elm_lang$core$Date$fromTime(at)
																															};
																														}),
																													updateBy,
																													updateAt)
...
var _user$project$API_Serialization$decodePerson = A3(
	_user$project$Util_DecodeUtil$optional$,
	'image',
	_elm_lang$core$Json_Decode$string,
	A3(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
							F6(
								function (id, name, post, mail, tel, image) {
									return {id: id, name: name, post: post, mail: mail, tel: tel, image: image};
								}))))))));
var _user$project$API_Serialization$decodeColorEntity = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'color',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model_ColorPalette$ColorEntity)))));
var _user$project$API_Serialization$decodeUser = _elm_lang$core$Json_Decode$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A3(
			...
			F2(
				function (role, person) {
					return _elm_lang$core$Native_Utils.eq(role, 'admin') ? _user$project$Model_User$admin(person) : _user$project$Model_User$general(person);
				}),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'role', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'person', _user$project$API_Serialization$decodePerson)),
			_elm_lang$core$Json_Decode$succeed(_user$project$Model_User$guest)
		]));
var _user$project$API_Serialization$encodeLogin = F2(
	function (userId, pass) {
...
var _user$project$API_Serialization$serializeLogin = F2(
	function (userId, pass) {
		return A2(
			_elm_lang$core$Json_Encode$encode,
			0,
			A2(_user$project$API_Serialization$encodeLogin, userId, pass));
	});
var _user$project$API_Serialization$encodeShape = function (shape) {
	var _p4 = shape;
...
var _user$project$API_Serialization$encodePrototype = function (_p5) {
	var _p6 = _p5;
	var _p7 = _p6.size;
	var width = _p7._0;
	var height = _p7._1;
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(_p6.id)
			},
				{
				ctor: '_Tuple2',
				_0: 'color',
				_1: _elm_lang$core$Json_Encode$string(_p6.color)
			},
				{
				ctor: '_Tuple2',
				_0: 'backgroundColor',
				_1: _elm_lang$core$Json_Encode$string(_p6.backgroundColor)
			},
				{
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(_p6.name)
			},
				{
				ctor: '_Tuple2',
				_0: 'width',
				_1: _elm_lang$core$Json_Encode$int(width)
			},
				{
				ctor: '_Tuple2',
				_0: 'height',
				_1: _elm_lang$core$Json_Encode$int(height)
			},
				{
				ctor: '_Tuple2',
				_0: 'fontSize',
				_1: _elm_lang$core$Json_Encode$float(_p6.fontSize)
			},
				{
				ctor: '_Tuple2',
				_0: 'shape',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$API_Serialization$encodeShape(_p6.shape))
			}
			]));
};
var _user$project$API_Serialization$serializePrototypes = function (prototypes) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		0,
		_elm_lang$core$Json_Encode$list(
			A2(_elm_lang$core$List$map, _user$project$API_Serialization$encodePrototype, prototypes)));
};
var _user$project$API_Serialization$encodeObject = function (object) {
	var _p8 = _user$project$Model_Object$rect(object);
	var x = _p8._0;
	var y = _p8._1;
	var w = _p8._2;
	var h = _p8._3;
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Model_Object$isDesk(object) ? 'desk' : 'label')
			},
				{
				ctor: '_Tuple2',
				_0: 'x',
				_1: _elm_lang$core$Json_Encode$int(x)
			},
				{
				ctor: '_Tuple2',
				_0: 'y',
				_1: _elm_lang$core$Json_Encode$int(y)
			},
				{
				ctor: '_Tuple2',
				_0: 'width',
				_1: _elm_lang$core$Json_Encode$int(w)
			},
				{
				ctor: '_Tuple2',
				_0: 'height',
				_1: _elm_lang$core$Json_Encode$int(h)
			},
				{
				ctor: '_Tuple2',
				_0: 'backgroundColor',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Model_Object$backgroundColorOf(object))
			},
				{
				ctor: '_Tuple2',
				_0: 'color',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Model_Object$colorOf(object))
			},
				{
				ctor: '_Tuple2',
				_0: 'shape',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$API_Serialization$encodeShape(
						_user$project$Model_Object$shapeOf(object)))
			},
				{
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Model_Object$nameOf(object))
			},
				{
				ctor: '_Tuple2',
				_0: 'fontSize',
				_1: _elm_lang$core$Json_Encode$float(
					_user$project$Model_Object$fontSizeOf(object))
			},
				{
				ctor: '_Tuple2',
				_0: 'personId',
				_1: function () {
					var _p9 = _user$project$Model_Object$relatedPerson(object);
					if (_p9.ctor === 'Just') {
...
var _user$project$API_Serialization$encodeObjectModification = function (mod) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'old',
				_1: _user$project$API_Serialization$encodeObject(mod.old)
			},
				{
				ctor: '_Tuple2',
				_0: 'new',
				_1: _user$project$API_Serialization$encodeObject(mod.$new)
			}
			]));
};
var _user$project$API_Serialization$encodeFloor = F2(
	function (floor, change) {
		return _elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					{
					ctor: '_Tuple2',
					_0: 'id',
					_1: _elm_lang$core$Json_Encode$string(floor.id)
				},
					{
					ctor: '_Tuple2',
					_0: 'version',
					_1: _elm_lang$core$Json_Encode$int(floor.version)
				},
					{
					ctor: '_Tuple2',
					_0: 'name',
					_1: _elm_lang$core$Json_Encode$string(floor.name)
				},
					{
					ctor: '_Tuple2',
					_0: 'ord',
					_1: _elm_lang$core$Json_Encode$int(floor.ord)
				},
					{
					ctor: '_Tuple2',
					_0: 'added',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$API_Serialization$encodeObject, change.added))
				},
					{
					ctor: '_Tuple2',
					_0: 'modified',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$API_Serialization$encodeObjectModification, change.modified))
				},
					{
					ctor: '_Tuple2',
					_0: 'deleted',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$API_Serialization$encodeObject, change.deleted))
				},
					{
					ctor: '_Tuple2',
					_0: 'width',
					_1: _elm_lang$core$Json_Encode$int(floor.width)
				},
					{
					ctor: '_Tuple2',
					_0: 'height',
					_1: _elm_lang$core$Json_Encode$int(floor.height)
				},
					{
					ctor: '_Tuple2',
					_0: 'realWidth',
					...
					_1: A2(
						_elm_lang$core$Maybe$withDefault,
						_elm_lang$core$Json_Encode$null,
						A2(_elm_lang$core$Maybe$map, _elm_lang$core$Json_Encode$string, floor.image))
				},
					{
					ctor: '_Tuple2',
					_0: 'public',
					_1: _elm_lang$core$Json_Encode$bool(floor.$public)
				}
				]));
	});
var _user$project$API_Serialization$serializeFloor = F2(
	function (floor, change) {
		return A2(
			_elm_lang$core$Json_Encode$encode,
			0,
			A2(_user$project$API_Serialization$encodeFloor, floor, change));
	});
var _user$project$API_Serialization$decodePeople = _elm_lang$core$Json_Decode$list(_user$project$API_Serialization$decodePerson);
var _user$project$API_Serialization$decodeFloorInfoList = _elm_lang$core$Json_Decode$list(_user$project$API_Serialization$decodeFloorInfo);
var _user$project$API_Serialization$decodeFloors = _elm_lang$core$Json_Decode$list(_user$project$API_Serialization$decodeFloor);
var _user$project$API_Serialization$decodePrototypes = _elm_lang$core$Json_Decode$list(_user$project$API_Serialization$decodePrototype);
var _user$project$API_Serialization$decodeColors = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Model_ColorPalette$init,
	_elm_lang$core$Json_Decode$list(_user$project$API_Serialization$decodeColorEntity));
var _user$project$API_Serialization$decodeAuthToken = A2(
	_elm_lang$core$Json_Decode$object1,
	_elm_lang$core$Basics$identity,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'accessToken', _elm_lang$core$Json_Decode$string));

var _user$project$API_API$gotoTop = _user$project$Util_HttpUtil$goTo('/');
var _user$project$API_API$goToLogout = _user$project$Util_HttpUtil$goTo('/logout');
var _user$project$API_API$goToLogin = _user$project$Util_HttpUtil$goTo('/login');
var _user$project$API_API$login = F3(
	function (accountServiceRoot, id, pass) {
		return A4(
			_user$project$Util_HttpUtil$postJson,
			_user$project$API_Serialization$decodeAuthToken,
			A2(_elm_lang$core$Basics_ops['++'], accountServiceRoot, '/1/authentication'),
			_elm_lang$core$Native_List.fromArray(
				[]),
			_evancz$elm_http$Http$string(
				A2(_user$project$API_Serialization$serializeLogin, id, pass)));
	});
var _user$project$API_API$getPeopleByFloorAndPost = F4(
	function (config, floorId, floorVersion, personId) {
		return A3(
			_user$project$Util_HttpUtil$get,
			_user$project$API_Serialization$decodePeople,
			A2(
				_evancz$elm_http$Http$url,
				A2(_elm_lang$core$Basics_ops['++'], config.apiRoot, '/1/people'),
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'floorId', _1: floorId},
						{
						ctor: '_Tuple2',
						_0: 'floorVersion',
						_1: _elm_lang$core$Basics$toString(floorVersion)
					},
						{ctor: '_Tuple2', _0: 'personId', _1: personId}
					])),
			_user$project$Util_HttpUtil$authorization(config.token));
	});
var _user$project$API_API$getPersonByUser = F2(
	function (config, id) {
		var getUser = A3(
			_user$project$Util_HttpUtil$get,
			_user$project$API_Serialization$decodeUser,
			A2(
				_elm_lang$core$Basics_ops['++'],
				config.apiRoot,
				A2(_elm_lang$core$Basics_ops['++'], '/1/users/', id)),
			_user$project$Util_HttpUtil$authorization(config.token));
		return A2(
			_elm_lang$core$Task$andThen,
			getUser,
			function (user) {
				...
				switch (_p0.ctor) {
					case 'Admin':
						return _elm_lang$core$Task$succeed(_p0._0);
					case 'General':
						return _elm_lang$core$Task$succeed(_p0._0);
					default:
						return _elm_lang$core$Task$succeed(
							{id: '', name: '', post: '', mail: _elm_lang$core$Maybe$Nothing, tel: _elm_lang$core$Maybe$Nothing, image: _elm_lang$core$Maybe$Nothing});
				}
			});
	});
var _user$project$API_API$getPerson = F2(
	function (config, id) {
		return A3(
			_user$project$Util_HttpUtil$get,
			_user$project$API_Serialization$decodePerson,
			A2(
				_elm_lang$core$Basics_ops['++'],
				config.apiRoot,
				A2(_elm_lang$core$Basics_ops['++'], '/1/people/', id)),
			_user$project$Util_HttpUtil$authorization(config.token));
	});
var _user$project$API_API$saveEditingImage = F3(
	function (config, id, file) {
		return A4(
			_user$project$Util_HttpUtil$sendFile,
			'PUT',
			A2(
				_elm_lang$core$Basics_ops['++'],
				config.apiRoot,
				A2(_elm_lang$core$Basics_ops['++'], '/1/images/', id)),
			_user$project$Util_HttpUtil$authorization(config.token),
			file);
	});
var _user$project$API_API$personCandidate = F2(
	function (config, name) {
		return _elm_lang$core$String$isEmpty(name) ? _elm_lang$core$Task$succeed(
			_elm_lang$core$Native_List.fromArray(
				[])) : A3(
			_user$project$Util_HttpUtil$getWithoutCache,
			_user$project$API_Serialization$decodePeople,
			A2(
				_elm_lang$core$Basics_ops['++'],
				config.apiRoot,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/1/candidates/',
					_evancz$elm_http$Http$uriEncode(name))),
			_user$project$Util_HttpUtil$authorization(config.token));
	});
var _user$project$API_API$search = F3(
	function (config, withPrivate, query) {
		var url = A2(
			_evancz$elm_http$Http$url,
			A2(
				_elm_lang$core$Basics_ops['++'],
			...
			withPrivate ? _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'all', _1: 'true'}
				]) : _elm_lang$core$Native_List.fromArray(
				[]));
		return A3(
			_user$project$Util_HttpUtil$get,
			_user$project$API_Serialization$decodeSearchResults,
			url,
			_user$project$Util_HttpUtil$authorization(config.token));
	});
var _user$project$API_API$getAuth = function (config) {
	return A3(
		_user$project$Util_HttpUtil$getWithoutCache,
		_user$project$API_Serialization$decodeUser,
		A2(_elm_lang$core$Basics_ops['++'], config.apiRoot, '/1/self'),
		_user$project$Util_HttpUtil$authorization(config.token));
};
var _user$project$API_API$getColors = function (config) {
	return A3(
		_user$project$Util_HttpUtil$getWithoutCache,
		_user$project$API_Serialization$decodeColors,
		A2(
			_evancz$elm_http$Http$url,
			A2(_elm_lang$core$Basics_ops['++'], config.apiRoot, '/1/colors'),
			_elm_lang$core$Native_List.fromArray(
				[])),
		_user$project$Util_HttpUtil$authorization(config.token));
};
var _user$project$API_API$savePrototypes = F2(
	function (config, prototypes) {
		return A3(
			_user$project$Util_HttpUtil$putJsonNoResponse,
			A2(_elm_lang$core$Basics_ops['++'], config.apiRoot, '/1/prototypes'),
			_user$project$Util_HttpUtil$authorization(config.token),
			_evancz$elm_http$Http$string(
				_user$project$API_Serialization$serializePrototypes(prototypes)));
	});
var _user$project$API_API$getPrototypes = function (config) {
	return A3(
		_user$project$Util_HttpUtil$getWithoutCache,
		_user$project$API_Serialization$decodePrototypes,
		A2(
			_evancz$elm_http$Http$url,
			A2(_elm_lang$core$Basics_ops['++'], config.apiRoot, '/1/prototypes'),
			_elm_lang$core$Native_List.fromArray(
...
var _user$project$API_API$getFloorsInfo = function (config) {
	var url = A2(
		_evancz$elm_http$Http$url,
		A2(_elm_lang$core$Basics_ops['++'], config.apiRoot, '/1/floors'),
		_elm_lang$core$Native_List.fromArray(
			[]));
	return A3(
		_user$project$Util_HttpUtil$getWithoutCache,
		_user$project$API_Serialization$decodeFloorInfoList,
		url,
		_user$project$Util_HttpUtil$authorization(config.token));
};
var _user$project$API_API$getFloorHelp = F3(
	function (config, withPrivate, id) {
		var url = A2(
			_evancz$elm_http$Http$url,
			A2(
				_elm_lang$core$Basics_ops['++'],
				config.apiRoot,
				A2(_elm_lang$core$Basics_ops['++'], '/1/floors/', id)),
			withPrivate ? _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'all', _1: 'true'}
				]) : _elm_lang$core$Native_List.fromArray(
		...
		return A3(
			_user$project$Util_HttpUtil$getWithoutCache,
			_user$project$API_Serialization$decodeFloor,
			url,
			_user$project$Util_HttpUtil$authorization(config.token));
	});
var _user$project$API_API$getFloorOfVersion = F3(
	function (config, id, version) {
		var url = A2(
			_evancz$elm_http$Http$url,
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$API_API$getFloor = F2(
	function (config, id) {
		return A3(_user$project$API_API$getFloorHelp, config, false, id);
	});
var _user$project$API_API$getFloorMaybe = F2(
	function (config, id) {
		return A2(
			_elm_lang$core$Task$onError,
			A2(
				_elm_lang$core$Task$andThen,
				A2(_user$project$API_API$getFloor, config, id),
				function (floor) {
					return _elm_lang$core$Task$succeed(
						_elm_lang$core$Maybe$Just(floor));
				}),
			function (e) {
				var _p1 = e;
				if ((_p1.ctor === 'BadResponse') && (_p1._0 === 404)) {
					return _elm_lang$core$Task$succeed(_elm_lang$core$Maybe$Nothing);
				} else {
					return _elm_lang$core$Task$fail(e);
				}
...
var _user$project$API_API$getEditingFloor = F2(
	function (config, id) {
		return A3(_user$project$API_API$getFloorHelp, config, true, id);
	});
var _user$project$API_API$getDiffSource = F2(
	function (config, id) {
		return A2(
			_elm_lang$core$Task$andThen,
			A2(_user$project$API_API$getEditingFloor, config, id),
			function (current) {
				return A2(
					_elm_lang$core$Task$andThen,
					A2(_user$project$API_API$getFloorMaybe, config, id),
					function (prev) {
						return _elm_lang$core$Task$succeed(
							{ctor: '_Tuple2', _0: current, _1: prev});
					});
			});
	});
var _user$project$API_API$publishEditingFloor = F2(
	function (config, id) {
		return A4(
			_user$project$Util_HttpUtil$putJson,
			_user$project$API_Serialization$decodeFloor,
			A2(
				_elm_lang$core$Basics_ops['++'],
				config.apiRoot,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/1/floors/',
					A2(_elm_lang$core$Basics_ops['++'], id, '/public'))),
			_user$project$Util_HttpUtil$authorization(config.token),
			_evancz$elm_http$Http$string(''));
	});
var _user$project$API_API$saveEditingFloor = F3(
	function (config, floor, change) {
		return A4(
			_user$project$Util_HttpUtil$putJson,
			_user$project$API_Serialization$decodeFloor,
			A2(
				_elm_lang$core$Basics_ops['++'],
				config.apiRoot,
				A2(_elm_lang$core$Basics_ops['++'], '/1/floors/', floor.id)),
			_user$project$Util_HttpUtil$authorization(config.token),
			_evancz$elm_http$Http$string(
				A2(_user$project$API_Serialization$serializeFloor, floor, change)));
	});
var _user$project$API_API$Config = F3(
	function (a, b, c) {
		return {apiRoot: a, accountServiceRoot: b, token: c};
	});

var _user$project$Model_I18n$search = function (lang) {
	var _p0 = lang;
	if (_p0.ctor === 'JA') {
		return '検索';
	} else {
...
var _user$project$Model_I18n$signInTo = F2(
	function (lang, title) {
		var _p1 = lang;
		if (_p1.ctor === 'JA') {
			return A2(_elm_lang$core$Basics_ops['++'], title, ' にサインイン');
		} else {
			return A2(_elm_lang$core$Basics_ops['++'], 'Sign in to ', title);
		}
	});
var _user$project$Model_I18n$password = function (lang) {
	var _p2 = lang;
	if (_p2.ctor === 'JA') {
		return 'パスワード';
	} else {
...
var _user$project$Model_I18n$mailAddress = function (lang) {
	var _p3 = lang;
	if (_p3.ctor === 'JA') {
		return 'メールアドレス';
	} else {
...
var _user$project$Model_I18n$nothingFound = function (lang) {
	var _p4 = lang;
	if (_p4.ctor === 'JA') {
		return '見つかりませんでした。';
	} else {
...
var _user$project$Model_I18n$loadImage = function (lang) {
	var _p5 = lang;
	if (_p5.ctor === 'JA') {
		return '画像を読み込む';
	} else {
...
var _user$project$Model_I18n$lastUpdateByAt = F3(
	function (lang, by, at) {
		var _p6 = lang;
		if (_p6.ctor === 'JA') {
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					by,
					A2(_elm_lang$core$Basics_ops['++'], ' ', at)));
		} else {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'Last Update by ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					by,
					A2(_elm_lang$core$Basics_ops['++'], ' at ', at)));
		}
	});
var _user$project$Model_I18n$publish = function (lang) {
	var _p7 = lang;
	if (_p7.ctor === 'JA') {
		return '変更を確認して公開';
	} else {
		return 'View changes and publish';
	}
};
var _user$project$Model_I18n$heightMeter = function (lang) {
	var _p8 = lang;
	if (_p8.ctor === 'JA') {
		return '縦(m)';
	} else {
...
var _user$project$Model_I18n$widthMeter = function (lang) {
	var _p9 = lang;
	if (_p9.ctor === 'JA') {
		return '横(m)';
	} else {
...
var _user$project$Model_I18n$order = function (lang) {
	var _p10 = lang;
	if (_p10.ctor === 'JA') {
		return '順番';
	} else {
...
var _user$project$Model_I18n$name = function (lang) {
	var _p11 = lang;
	if (_p11.ctor === 'JA') {
		return 'フロア名';
	} else {
...
var _user$project$Model_I18n$edit = function (lang) {
	var _p12 = lang;
	if (_p12.ctor === 'JA') {
		return '編集';
	} else {
...
var _user$project$Model_I18n$print = function (lang) {
	var _p13 = lang;
	if (_p13.ctor === 'JA') {
		return '印刷';
	} else {
...
var _user$project$Model_I18n$close = function (lang) {
	var _p14 = lang;
	if (_p14.ctor === 'JA') {
		return '閉じる';
	} else {
...
var _user$project$Model_I18n$signOut = function (lang) {
	var _p15 = lang;
	if (_p15.ctor === 'JA') {
		return 'サインアウト';
	} else {
...
var _user$project$Model_I18n$signIn = function (lang) {
	var _p16 = lang;
	if (_p16.ctor === 'JA') {
		return 'サインイン';
	} else {
...
var _user$project$Model_I18n$unexpectedBadResponse = function (lang) {
	var _p17 = lang;
	if (_p17.ctor === 'JA') {
		return '予期しないエラー(BadResponse)';
	} else {
		return 'Unexpected BadResponse';
	}
};
var _user$project$Model_I18n$conflictSomeoneHasAlreadyChangedPleaseRefreshAndTryAgain = function (lang) {
	var _p18 = lang;
	if (_p18.ctor === 'JA') {
		return '競合: 他のユーザがすでに変更しています。リフレッシュ(F5)してからもう一度試してください。';
	} else {
		return 'Conflict: Someone has already changed. Please refresh(F5) and try again.';
	}
};
var _user$project$Model_I18n$unexpectedPayload = function (lang) {
	var _p19 = lang;
	if (_p19.ctor === 'JA') {
		return '予期しないペイロード';
	} else {
...
var _user$project$Model_I18n$networkErrorDetectedPleaseRefreshAndTryAgain = function (lang) {
	var _p20 = lang;
	if (_p20.ctor === 'JA') {
		return 'ネットワークエラーが検出されました。リフレッシュ(F5)してからもう一度試してください。';
	} else {
		return 'NetworkError detected. Please refresh(F5) and try again.';
	}
};
var _user$project$Model_I18n$timeout = function (lang) {
	var _p21 = lang;
	if (_p21.ctor === 'JA') {
		return 'タイムアウト';
	} else {
...
var _user$project$Model_I18n$unexpectedHtmlError = function (lang) {
	var _p22 = lang;
	if (_p22.ctor === 'JA') {
		return '予期しないエラー(HtmlError): ';
	} else {
		return 'Unexpected HtmlError: ';
	}
};
var _user$project$Model_I18n$unexpectedFileError = function (lang) {
	var _p23 = lang;
	if (_p23.ctor === 'JA') {
		return '予期しないエラー(FileError): ';
	} else {
		return 'Unexpected FileError: ';
	}
};
var _user$project$Model_I18n$missing = function (lang) {
	var _p24 = lang;
	if (_p24.ctor === 'JA') {
		return '未登録';
	} else {
...
var _user$project$Model_I18n$confirm = function (lang) {
	var _p25 = lang;
	if (_p25.ctor === 'JA') {
		return '確認';
	} else {
...
var _user$project$Model_I18n$cancel = function (lang) {
	var _p26 = lang;
	if (_p26.ctor === 'JA') {
		return 'キャンセル';
	} else {
...
var _user$project$Model_I18n$pasteFromSpreadsheet = function (lang) {
	var _p27 = lang;
	if (_p27.ctor === 'JA') {
		return 'スプレッドシートから貼り付け';
	} else {
		return 'Paste from Spreadsheet';
	}
};
var _user$project$Model_I18n$copyFloor = function (lang) {
	var _p28 = lang;
	if (_p28.ctor === 'JA') {
		return 'フロアを複製する';
	} else {
...
var _user$project$Model_I18n$removeSpaces = function (lang) {
	var _p29 = lang;
	if (_p29.ctor === 'JA') {
		return '空白文字を除去';
	} else {
...
var _user$project$Model_I18n$pickupFirstWord = function (lang) {
	var _p30 = lang;
	if (_p30.ctor === 'JA') {
		return '最初の単語を抜き出す';
	} else {
		return 'Pickup first word';
	}
};
var _user$project$Model_I18n$rotate = function (lang) {
	var _p31 = lang;
	if (_p31.ctor === 'JA') {
		return '90度回転する';
	} else {
...
var _user$project$Model_I18n$registerAsStamp = function (lang) {
	var _p32 = lang;
	if (_p32.ctor === 'JA') {
		return 'スタンプとして登録する';
	} else {
		return 'Register as stamp';
	}
};
var _user$project$Model_I18n$selectIsland = function (lang) {
	var _p33 = lang;
	if (_p33.ctor === 'JA') {
		return '島を選択する';
	} else {
...
var _user$project$Model_I18n$selectSamePost = function (lang) {
	var _p34 = lang;
	if (_p34.ctor === 'JA') {
		return '同じ部署の人を選択';
	} else {
		return 'Select people in the same post';
	}
};
var _user$project$Model_I18n$EN = {ctor: 'EN'};
var _user$project$Model_I18n$JA = {ctor: 'JA'};

var _user$project$Model_Scale$ratio = F2(
	function (old, $new) {
		return _elm_lang$core$Basics$toFloat(
			Math.pow(2, old.scaleDown)) / _elm_lang$core$Basics$toFloat(
			Math.pow(2, $new.scaleDown));
	});
var _user$project$Model_Scale$imageToScreenRatio = function (scale) {
	return 1.0 / Math.pow(
		2,
		_elm_lang$core$Basics$toFloat(scale.scaleDown));
};
var _user$project$Model_Scale$imageToScreen = F2(
	function (scale, screenLength) {
		return (screenLength / Math.pow(2, scale.scaleDown)) | 0;
	});
var _user$project$Model_Scale$screenToImage = F2(
	function (scale, imageLength) {
		return imageLength * Math.pow(2, scale.scaleDown);
	});
var _user$project$Model_Scale$screenToImageForRect = F2(
	function (scale, _p0) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple4',
			_0: A2(_user$project$Model_Scale$screenToImage, scale, _p1._0),
			_1: A2(_user$project$Model_Scale$screenToImage, scale, _p1._1),
			_2: A2(_user$project$Model_Scale$screenToImage, scale, _p1._2),
			_3: A2(_user$project$Model_Scale$screenToImage, scale, _p1._3)
		};
	});
var _user$project$Model_Scale$imageToScreenForRect = F2(
	function (scale, _p2) {
		var _p3 = _p2;
		return {
			ctor: '_Tuple4',
			_0: A2(_user$project$Model_Scale$imageToScreen, scale, _p3._0),
			_1: A2(_user$project$Model_Scale$imageToScreen, scale, _p3._1),
			_2: A2(_user$project$Model_Scale$imageToScreen, scale, _p3._2),
			_3: A2(_user$project$Model_Scale$imageToScreen, scale, _p3._3)
		};
	});
var _user$project$Model_Scale$imageToScreenForPosition = F2(
	function (scale, _p4) {
		var _p5 = _p4;
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Model_Scale$imageToScreen, scale, _p5._0),
			_1: A2(_user$project$Model_Scale$imageToScreen, scale, _p5._1)
		};
	});
var _user$project$Model_Scale$screenToImageForPosition = F2(
	function (scale, _p6) {
		var _p7 = _p6;
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Model_Scale$screenToImage, scale, _p7._0),
			_1: A2(_user$project$Model_Scale$screenToImage, scale, _p7._1)
		};
	});
var _user$project$Model_Scale$update = F2(
	function (msg, scale) {
		var _p8 = msg;
		if (_p8.ctor === 'ScaleUp') {
			return _elm_lang$core$Native_Utils.update(
				scale,
				{
					scaleDown: A2(_elm_lang$core$Basics$max, 0, scale.scaleDown - 1)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				scale,
				{
					scaleDown: A2(_elm_lang$core$Basics$min, 4, scale.scaleDown + 1)
				});
		}
	});
var _user$project$Model_Scale$init = function (scaleDown) {
	return {scaleDown: scaleDown};
};
var _user$project$Model_Scale$default = _user$project$Model_Scale$init(0);
var _user$project$Model_Scale$Scale = function (a) {
	return {scaleDown: a};
};
var _user$project$Model_Scale$ScaleDown = {ctor: 'ScaleDown'};
var _user$project$Model_Scale$ScaleUp = {ctor: 'ScaleUp'};

var _user$project$Model_ProfilePopupLogic$adjust = F5(
	function (scale, length, min, max, offset) {
		return (_elm_lang$core$Native_Utils.cmp(min, 0) < 0) ? (offset - A2(_user$project$Model_Scale$screenToImage, scale, min - 0)) : ((_elm_lang$core$Native_Utils.cmp(max, length) > 0) ? (offset - A2(_user$project$Model_Scale$screenToImage, scale, max - length)) : offset);
	});
var _user$project$Model_ProfilePopupLogic$calcPopupTopFromObjectTop = F2(
	function (popupHeight, objTop) {
		return objTop - (popupHeight + 10);
	});
var _user$project$Model_ProfilePopupLogic$calcPopupRightFromObjectCenter = F2(
	function (popupWidth, objCenter) {
		return objCenter + ((popupWidth / 2) | 0);
	});
var _user$project$Model_ProfilePopupLogic$calcPopupLeftFromObjectCenter = F2(
	function (popupWidth, objCenter) {
		return objCenter - ((popupWidth / 2) | 0);
	});
var _user$project$Model_ProfilePopupLogic$bottomScreenYOfObject = F3(
	function (scale, _p0, object) {
		var _p1 = _p0;
		var _p2 = _user$project$Model_Object$rect(object);
		var x = _p2._0;
		var y = _p2._1;
		var w = _p2._2;
		var h = _p2._3;
		return A2(_user$project$Model_Scale$imageToScreen, scale, (_p1._1 + y) + h);
	});
var _user$project$Model_ProfilePopupLogic$centerTopScreenXYOfObject = F3(
	function (scale, _p3, object) {
		var _p4 = _p3;
		var _p5 = _user$project$Model_Object$rect(object);
		var x = _p5._0;
		var y = _p5._1;
		var w = _p5._2;
		var h = _p5._3;
		return A2(
			_user$project$Model_Scale$imageToScreenForPosition,
			scale,
			{ctor: '_Tuple2', _0: (_p4._0 + x) + ((w / 2) | 0), _1: _p4._1 + y});
	});
var _user$project$Model_ProfilePopupLogic$adjustOffset = F5(
	function (_p8, _p7, scale, _p6, object) {
		var _p9 = _p8;
		var _p10 = _p7;
		var _p15 = _p10._0;
		var _p11 = _p6;
		...
		var _p13 = _p11._0;
		var bottom = A3(
			_user$project$Model_ProfilePopupLogic$bottomScreenYOfObject,
			scale,
			{ctor: '_Tuple2', _0: _p13, _1: _p14},
			object);
		var _p12 = A3(
			_user$project$Model_ProfilePopupLogic$centerTopScreenXYOfObject,
			scale,
			{ctor: '_Tuple2', _0: _p13, _1: _p14},
			object);
		var objCenter = _p12._0;
		var objTop = _p12._1;
		var left = A2(_user$project$Model_ProfilePopupLogic$calcPopupLeftFromObjectCenter, _p15, objCenter);
		var top = A2(_user$project$Model_ProfilePopupLogic$calcPopupTopFromObjectTop, _p10._1, objTop);
		var offsetY$ = A5(_user$project$Model_ProfilePopupLogic$adjust, scale, _p9._1, top, bottom, _p14);
		var right = A2(_user$project$Model_ProfilePopupLogic$calcPopupRightFromObjectCenter, _p15, objCenter);
		var offsetX$ = A5(_user$project$Model_ProfilePopupLogic$adjust, scale, _p9._0, left, right, _p13);
		return {ctor: '_Tuple2', _0: offsetX$, _1: offsetY$};
	});

var _user$project$Util_StyleUtil$rgba = F4(
	function (r, g, b, a) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'rgba(',
...
var _user$project$Util_StyleUtil$rgb = F3(
	function (r, g, b) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'rgb(',
...
var _user$project$Util_StyleUtil$em = function (num) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(num),
		'em');
};
var _user$project$Util_StyleUtil$px = function (num) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(num),
		'px');
...
var _user$project$View_Styles$nameInputContainer = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'relative'}
	]);
var _user$project$View_Styles$searchResultItemIcon = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'width', _1: '30px'},
		{ctor: '_Tuple2', _0: 'height', _1: '20px'},
		{ctor: '_Tuple2', _0: 'margin-top', _1: '-2px'}
	]);
var _user$project$View_Styles$unsetRelatedPersonButton = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'top', _1: '15px'},
		{ctor: '_Tuple2', _0: 'right', _1: '15px'},
		{ctor: '_Tuple2', _0: 'padding', _1: '5px'},
		{ctor: '_Tuple2', _0: 'background-color', _1: '#fff'},
		{ctor: '_Tuple2', _0: 'color', _1: '#ddd'},
		{ctor: '_Tuple2', _0: 'border', _1: 'solid 1px #ddd'},
		{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'},
		{ctor: '_Tuple2', _0: 'display', _1: 'inline-block'},
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'}
	]);
var _user$project$View_Styles$candidateItemPersonPost = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'font-size', _1: 'small'},
		{ctor: '_Tuple2', _0: 'top', _1: '40px'}
	]);
var _user$project$View_Styles$candidateItemPersonName = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'fon-size', _1: 'larger'},
		{ctor: '_Tuple2', _0: 'font-weight', _1: 'bold'},
		{ctor: '_Tuple2', _0: 'top', _1: '15px'}
	]);
var _user$project$View_Styles$candidatesViewRelatedPerson = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'width', _1: '300px'},
		{ctor: '_Tuple2', _0: 'height', _1: '160px'},
		{ctor: '_Tuple2', _0: 'position', _1: 'relative'},
		{ctor: '_Tuple2', _0: 'padding', _1: '15px'},
		{ctor: '_Tuple2', _0: 'background-color', _1: '#fff'},
		{ctor: '_Tuple2', _0: 'border-bottom', _1: 'solid 1px #ddd'}
	]);
var _user$project$View_Styles$candidatesView = _elm_lang$core$Native_List.fromArray(
	[]);
var _user$project$View_Styles$candidateItemHeight = 55;
var _user$project$View_Styles$personDetailPopupPersonIconText = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin-left', _1: '5px'},
		{ctor: '_Tuple2', _0: 'font-size', _1: 'small'}
	]);
var _user$project$View_Styles$personDetailPopupPersonPost = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'font-size', _1: 'small'},
		{ctor: '_Tuple2', _0: 'top', _1: '105px'}
	]);
var _user$project$View_Styles$personDetailPopupPersonName = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'fon-size', _1: 'larger'},
		{ctor: '_Tuple2', _0: 'font-weight', _1: 'bold'},
...
var _user$project$View_Styles$personDetailPopupPersonNo = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'fon-size', _1: 'small'},
		{ctor: '_Tuple2', _0: 'top', _1: '5px'}
	]);
var _user$project$View_Styles$personDetailPopupPersonImage = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'top', _1: '15px'},
		{ctor: '_Tuple2', _0: 'max-width', _1: '60px'}
	]);
var _user$project$View_Styles$personDetailPopupClose = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'top', _1: '10px'},
		{ctor: '_Tuple2', _0: 'right', _1: '10px'}
	]);
var _user$project$View_Styles$popupPointerBase = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$View_Styles$popupPointerButtom = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$popupPointerBase,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'transform', _1: 'rotate(45deg)'},
			{ctor: '_Tuple2', _0: 'box-shadow', _1: 'rgba(0, 0, 0, 0.237255) 2px 2px 5px 0px'}
		]));
var _user$project$View_Styles$personDetailPopupPointer = function (width) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$popupPointerButtom,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'left',
				_1: _user$project$Util_StyleUtil$px(((width / 2) | 0) - ((20 / 2) | 0))
			}
			]));
};
var _user$project$View_Styles$personDetailPopupPointerDefault = function (width) {
	return _user$project$View_Styles$personDetailPopupPointer(width);
};
var _user$project$View_Styles$personDetailPopupPointerSmall = _user$project$View_Styles$personDetailPopupPointer(80);
var _user$project$View_Styles$popupPointerLeft = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$popupPointerBase,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'transform', _1: 'rotate(45deg)'},
			{ctor: '_Tuple2', _0: 'box-shadow', _1: 'rgba(0, 0, 0, 0.237255) -1.5px 1.5px 4.5px 0px'}
		]));
var _user$project$View_Styles$candidateViewPointer = function (screenRectOfDesk) {
	var _p0 = screenRectOfDesk;
	var x = _p0._0;
	var y = _p0._1;
	var w = _p0._2;
	var h = _p0._3;
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$popupPointerLeft,
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'top',
				_1: _user$project$Util_StyleUtil$px(top)
			},
				{
				ctor: '_Tuple2',
				_0: 'left',
				_1: _user$project$Util_StyleUtil$px(left)
			}
			]));
};
var _user$project$View_Styles$personDetailPopupNoPerson = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
		{ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'},
		{ctor: '_Tuple2', _0: 'text-overflow', _1: 'ellipsis'}
	]);
var _user$project$View_Styles$diffPopupInnerContainer = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'relative'},
		{ctor: '_Tuple2', _0: 'height', _1: '100%'}
	]);
var _user$project$View_Styles$diffPopupBody = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'overflow-y', _1: 'scroll'},
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'top', _1: '60px'},
		{ctor: '_Tuple2', _0: 'bottom', _1: '50px'},
		{ctor: '_Tuple2', _0: 'right', _1: '0'},
		{ctor: '_Tuple2', _0: 'left', _1: '0'}
	]);
var _user$project$View_Styles$diffPopupHeader = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin', _1: '0'},
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'height', _1: '60px'},
		{ctor: '_Tuple2', _0: 'line-height', _1: '60px'},
		{ctor: '_Tuple2', _0: 'right', _1: '0'},
		{ctor: '_Tuple2', _0: 'left', _1: '0'}
	]);
var _user$project$View_Styles$popup = function (padding) {
	return _elm_lang$core$Native_List.fromArray(
		[
			...
			ctor: '_Tuple2',
			_0: 'padding',
			_1: _user$project$Util_StyleUtil$px(padding)
		},
			{ctor: '_Tuple2', _0: 'background-color', _1: '#fff'},
			{ctor: '_Tuple2', _0: 'position', _1: 'absolute'}
		]);
};
var _user$project$View_Styles$defaultPopup = _user$project$View_Styles$popup(20);
var _user$project$View_Styles$smallPopup = _user$project$View_Styles$popup(10);
var _user$project$View_Styles$personMatchingInfo = function (ratio) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'border-radius',
			_1: _user$project$Util_StyleUtil$px(10 * ratio)
		},
			{
			ctor: '_Tuple2',
			_0: 'width',
			_1: _user$project$Util_StyleUtil$px(20 * ratio)
		},
			{
			ctor: '_Tuple2',
			_0: 'height',
...
var _user$project$View_Styles$personMatched = function (ratio) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$personMatchingInfo(ratio),
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'background-color', _1: '#6a6'}
			]));
};
var _user$project$View_Styles$personNotMatched = function (ratio) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$personMatchingInfo(ratio),
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$View_Styles$floorsInfoViewItemLink = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$View_Styles$floorsInfoViewItemHover = function ($private) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
...
var _user$project$View_Styles$searchResultItem = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'padding', _1: '5px'}
	]);
var _user$project$View_Styles$loginCaption = _elm_lang$core$Native_List.fromArray(
	[]);
var _user$project$View_Styles$loginContainer = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$View_Styles$greetingName = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin-left', _1: '10px'},
		{ctor: '_Tuple2', _0: 'margin-top', _1: '5px'},
		{ctor: '_Tuple2', _0: 'line-height', _1: '30px'}
	]);
var _user$project$View_Styles$greetingImage = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'width', _1: '24px'},
		{ctor: '_Tuple2', _0: 'height', _1: '24px'},
		{ctor: '_Tuple2', _0: 'margin-top', _1: '6px'},
		{ctor: '_Tuple2', _0: 'border', _1: 'solid 1px #888'}
	]);
var _user$project$View_Styles$editingToggleText = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin-left', _1: '5px'},
		{ctor: '_Tuple2', _0: 'margin-top', _1: '5px'},
		{ctor: '_Tuple2', _0: 'line-height', _1: '30px'},
...
var _user$project$View_Styles$editingToggleIcon = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'padding-top', _1: '7px'}
	]);
var _user$project$View_Styles$langSelectView = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'}
	]);
var _user$project$View_Styles$userMenuToggleIcon = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin-top', _1: '10px'},
		{ctor: '_Tuple2', _0: 'right', _1: '10px'},
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'}
	]);
var _user$project$View_Styles$headerMenu = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		{ctor: '_Tuple2', _0: 'justify-content', _1: 'flex-end'}
	]);
var _user$project$View_Styles$floorPropertyText = _elm_lang$core$Native_List.fromArray(
	[
		...
		{ctor: '_Tuple2', _0: 'border-bottom', _1: '1px dotted #aaa'}
	]);
var _user$project$View_Styles$floorNameText = _user$project$View_Styles$floorPropertyText;
var _user$project$View_Styles$floorOrdText = _user$project$View_Styles$floorPropertyText;
var _user$project$View_Styles$floorWidthText = _user$project$View_Styles$floorPropertyText;
var _user$project$View_Styles$floorHeightText = _user$project$View_Styles$floorPropertyText;
var _user$project$View_Styles$floorPropertyLabel = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'block'},
		{ctor: '_Tuple2', _0: 'line-height', _1: '30px'},
...
var _user$project$View_Styles$floorNameLabel = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '124px'}
		]),
	_user$project$View_Styles$floorPropertyLabel);
var _user$project$View_Styles$floorOrdLabel = _user$project$View_Styles$floorNameLabel;
var _user$project$View_Styles$widthHeightLabel = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
	...
	_user$project$View_Styles$floorPropertyLabel);
var _user$project$View_Styles$button = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'block'},
		{ctor: '_Tuple2', _0: 'height', _1: '30px'},
		{ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
...
var _user$project$View_Styles$defaultButton = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$button,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: '#eee'},
			{ctor: '_Tuple2', _0: 'border', _1: 'solid 1px #aaa'}
		]));
var _user$project$View_Styles$diffPopupCancelButton = _user$project$View_Styles$defaultButton;
var _user$project$View_Styles$formControl = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin-bottom', _1: '6px'}
	]);
var _user$project$View_Styles$imageLoadButton = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$formControl,
	A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$defaultButton,
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'width', _1: '120px'}
			])));
var _user$project$View_Styles$floorPropertyLastUpdate = _user$project$View_Styles$formControl;
var _user$project$View_Styles$prototypePreviewViewInner = F2(
	function (containerWidth, index) {
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'left',
				_1: _user$project$Util_StyleUtil$px(index * (0 - containerWidth))
			},
				{ctor: '_Tuple2', _0: 'transition-property', _1: 'left'},
				{ctor: '_Tuple2', _0: 'transition-duration', _1: '0.2s'}
			]);
	});
var _user$project$View_Styles$transition = F2(
	function (properties, disabled) {
		return disabled ? _elm_lang$core$Native_List.fromArray(
			[]) : _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'transition-property',
				_1: A2(_elm_lang$core$String$join, ', ', properties)
			},
				{ctor: '_Tuple2', _0: 'transition-duration', _1: '0.2s'}
			]);
	});
var _user$project$View_Styles$card = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'padding', _1: '20px'},
		{ctor: '_Tuple2', _0: 'box-shadow', _1: 'rgba(0, 0, 0, 0.08451) -2px 2px 4px inset'}
	]);
var _user$project$View_Styles$shadow = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'box-shadow', _1: '0 2px 2px 0 rgba(0,0,0,.14),0 3px 1px -2px rgba(0,0,0,.2),0 1px 5px 0 rgba(0,0,0,.12)'}
	]);
var _user$project$View_Styles$diffPopup = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$defaultPopup,
	A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'left', _1: '20%'},
				{ctor: '_Tuple2', _0: 'right', _1: '20%'},
				{ctor: '_Tuple2', _0: 'top', _1: '10%'},
				{ctor: '_Tuple2', _0: 'bottom', _1: '10%'}
			]),
		_user$project$View_Styles$shadow));
var _user$project$View_Styles$canvasContainer = F2(
	function (printMode, rangeSelectMode) {
		return _elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'position', _1: 'relative'},
				{
				ctor: '_Tuple2',
				_0: 'background',
				_1: printMode ? '#fff' : '#000'
			},
				{ctor: '_Tuple2', _0: 'flex', _1: '1'},
				{
				ctor: '_Tuple2',
				_0: 'cursor',
				_1: rangeSelectMode ? 'crosshair' : 'default'
			}
			]);
	});
var _user$project$View_Styles$canvasImage = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'width', _1: '100%'},
		{ctor: '_Tuple2', _0: 'height', _1: '100%'}
	]);
var _user$project$View_Styles$canvasViewForPrint = F2(
	function (_p2, _p1) {
		var _p3 = _p2;
		var _p4 = _p1;
		var _p6 = _p4._2;
		...
		var scale = _elm_lang$core$Basics$toString(
			A2(
				_elm_lang$core$Basics$min,
				_elm_lang$core$Basics$toFloat(_p3._0) / _elm_lang$core$Basics$toFloat(_p6),
				_elm_lang$core$Basics$toFloat(_p3._1) / _elm_lang$core$Basics$toFloat(_p5)));
		return _elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'background-color', _1: '#fff'},
				...
				ctor: '_Tuple2',
				_0: 'width',
				_1: _user$project$Util_StyleUtil$px(_p6)
			},
				{
				ctor: '_Tuple2',
				_0: 'height',
				_1: _user$project$Util_StyleUtil$px(_p5)
			},
				{
				ctor: '_Tuple2',
				_0: 'transform',
				...
				{ctor: '_Tuple2', _0: 'transform-origin', _1: 'top left'},
				{ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'}
			]);
	});
var _user$project$View_Styles$contextMenuItemHover = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'background-color', _1: '#9ce'}
	]);
var _user$project$View_Styles$contextMenuItem = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'padding', _1: '5px'},
		{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'}
	]);
var _user$project$View_Styles$shapeProperties = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'}
	]);
var _user$project$View_Styles$propertyViewPropertyIcon = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'width', _1: '12px'}
	]);
var _user$project$View_Styles$colorProperties = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'}
	]);
var _user$project$View_Styles$rect = function (_p7) {
	var _p8 = _p7;
	return _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'top',
			_1: _user$project$Util_StyleUtil$px(_p8._1)
		},
			{
			ctor: '_Tuple2',
			_0: 'left',
			_1: _user$project$Util_StyleUtil$px(_p8._0)
		},
			{
			ctor: '_Tuple2',
			_0: 'width',
			_1: _user$project$Util_StyleUtil$px(_p8._2)
		},
			{
			ctor: '_Tuple2',
			_0: 'height',
			_1: _user$project$Util_StyleUtil$px(_p8._3)
		}
		]);
};
var _user$project$View_Styles$absoluteRect = function (rect$) {
	return A2(
		_elm_lang$core$List_ops['::'],
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		_user$project$View_Styles$rect(rect$));
};
var _user$project$View_Styles$canvasView = F3(
	function (isViewing, disableTransition, rect) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_Styles$absoluteRect(rect),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Native_List.fromArray(
					[
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					isViewing ? _elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'}
						]) : _elm_lang$core$Native_List.fromArray(
						[]),
					A2(
						_user$project$View_Styles$transition,
						_elm_lang$core$Native_List.fromArray(
							['width', 'height', 'top', 'left']),
						disableTransition))));
	});
var _user$project$View_Styles$headerHeight = 37;
var _user$project$View_Styles$hoverHeaderIconHover = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'opacity', _1: '0.7'}
	]);
var _user$project$View_Styles$headerIconHover = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'opacity', _1: '0.5'}
	]);
var _user$project$View_Styles$headerLink = _elm_lang$core$Native_List.fromArray(
	[]);
var _user$project$View_Styles$flex = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'}
	]);
var _user$project$View_Styles$modeSelectionView = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin-top', _1: '10px'}
		]),
	_user$project$View_Styles$flex);
var _user$project$View_Styles$floorNameInputContainer = A2(_elm_lang$core$Basics_ops['++'], _user$project$View_Styles$formControl, _user$project$View_Styles$flex);
var _user$project$View_Styles$floorOrdInputContainer = _user$project$View_Styles$floorNameInputContainer;
var _user$project$View_Styles$floorSizeInputContainer = A2(_elm_lang$core$Basics_ops['++'], _user$project$View_Styles$formControl, _user$project$View_Styles$flex);
var _user$project$View_Styles$editingToggleContainer = function (editing) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$flex,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$View_Styles$userMenuToggle = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$flex,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View_Styles$searchResultItemInner = F2(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'text-decoration',
					_1: selectable ? 'underline' : ''
				},
					{
					ctor: '_Tuple2',
					_0: 'cursor',
					_1: selectable ? 'pointer' : ''
				},
					{
					ctor: '_Tuple2',
					_0: 'font-weight',
...
var _user$project$View_Styles$diffPopupFooter = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
	...
	_user$project$View_Styles$flex);
var _user$project$View_Styles$personDetailPopupPersonTel = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$flex,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View_Styles$personDetailPopupPersonMail = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$flex,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
			{ctor: '_Tuple2', _0: 'top', _1: '70px'},
			{ctor: '_Tuple2', _0: 'left', _1: '100px'}
		]));
var _user$project$View_Styles$candidateItemPersonMail = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$flex,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View_Styles$mainView = function (windowHeight) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'height',
				_1: _user$project$Util_StyleUtil$px(windowHeight - _user$project$View_Styles$headerHeight)
			},
				{ctor: '_Tuple2', _0: 'position', _1: 'relative'},
				{ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'}
			]),
...
var _user$project$View_Styles$noPadding = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'padding', _1: '0'}
	]);
var _user$project$View_Styles$noMargin = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin', _1: '0'}
	]);
var _user$project$View_Styles$h1 = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$noMargin,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'font-size', _1: '1.4em'},
			{ctor: '_Tuple2', _0: 'font-weight', _1: 'normal'},
			{
			ctor: '_Tuple2',
			_0: 'line-height',
			_1: _user$project$Util_StyleUtil$px(_user$project$View_Styles$headerHeight)
		}
		]));
var _user$project$View_Styles$header = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$noMargin,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background', _1: 'rgb(100,100,120)'},
...
var _user$project$View_Styles$nameLabel = F4(
	function (color, scale, fontSize, disableTransition) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'font-size',
					_1: _user$project$Util_StyleUtil$px(fontSize)
				},
					{ctor: '_Tuple2', _0: 'width', _1: '100%'},
					{ctor: '_Tuple2', _0: 'word-wrap', _1: 'break-word'},
...
var _user$project$View_Styles$headerMenuItem = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$noMargin,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View_Styles$closePrint = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '80px'},
	...
	_user$project$View_Styles$headerMenuItem);
var _user$project$View_Styles$login = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '80px'},
	...
	_user$project$View_Styles$headerMenuItem);
var _user$project$View_Styles$logout = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '80px'},
	...
	_user$project$View_Styles$headerMenuItem);
var _user$project$View_Styles$hoverBackgroundColor = '#9ce';
var _user$project$View_Styles$candidateItem = function (selected) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '300px'},
			{
			ctor: '_Tuple2',
			_0: 'height',
			_1: _user$project$Util_StyleUtil$px(_user$project$View_Styles$candidateItemHeight)
		},
			{ctor: '_Tuple2', _0: 'position', _1: 'relative'},
			{ctor: '_Tuple2', _0: 'padding', _1: '15px'},
			{ctor: '_Tuple2', _0: 'border-bottom', _1: 'solid 1px #ddd'},
			...
			ctor: '_Tuple2',
			_0: 'background-color',
			_1: selected ? _user$project$View_Styles$hoverBackgroundColor : '#fff'
		},
			{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'}
		]);
};
var _user$project$View_Styles$candidateItemHover = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'background-color', _1: _user$project$View_Styles$hoverBackgroundColor}
	]);
var _user$project$View_Styles$errorTextColor = '#d45';
var _user$project$View_Styles$loginError = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'color', _1: _user$project$View_Styles$errorTextColor},
		{ctor: '_Tuple2', _0: 'margin-bottom', _1: '15px'}
	]);
var _user$project$View_Styles$selectColor = '#69e';
var _user$project$View_Styles$deskResizeGrip = function (selected) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Native_List.fromArray(
			[
				...
				{ctor: '_Tuple2', _0: 'bottom', _1: '-2px'},
				{ctor: '_Tuple2', _0: 'right', _1: '-2px'},
				{ctor: '_Tuple2', _0: 'cursor', _1: 'nw-resize'}
			]),
		selected ? _elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'border-bottom-style', _1: 'solid'},
				{ctor: '_Tuple2', _0: 'border-right-style', _1: 'solid'},
				{ctor: '_Tuple2', _0: 'border-width', _1: '2px'},
				{ctor: '_Tuple2', _0: 'border-color', _1: _user$project$View_Styles$selectColor}
			]) : _elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$View_Styles$colorProperty = F2(
	function (color, selected) {
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'border-color',
				_1: selected ? _user$project$View_Styles$selectColor : '#666'
			},
				{ctor: '_Tuple2', _0: 'font-size', _1: '12px'}
			]);
	});
var _user$project$View_Styles$shapeProperty = function (selected) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'},
			{ctor: '_Tuple2', _0: 'width', _1: '24px'},
...
var _user$project$View_Styles$prototypePreviewView = function (stampMode) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'height', _1: '238px'},
			{ctor: '_Tuple2', _0: 'position', _1: 'relative'},
			...
			ctor: '_Tuple2',
			_0: 'border-color',
			_1: stampMode ? _user$project$View_Styles$selectColor : '#666'
		},
			{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
			{ctor: '_Tuple2', _0: 'margin-top', _1: '10px'},
			{ctor: '_Tuple2', _0: 'background-color', _1: '#fff'},
...
var _user$project$View_Styles$langSelectViewItem = function (selected) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'background-color',
			_1: selected ? _user$project$View_Styles$selectColor : ''
		},
			{ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
...
var _user$project$View_Styles$floorsInfoViewItem = F2(
	function (selected, $private) {
		return _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'background-color',
				_1: $private ? '#dbdbdb' : '#fff'
			},
				{
				ctor: '_Tuple2',
				_0: 'border-right',
				_1: selected ? A2(_elm_lang$core$Basics_ops['++'], 'solid 2px ', _user$project$View_Styles$selectColor) : 'solid 1px #d0d0d0'
			},
				{
				ctor: '_Tuple2',
				_0: 'border-bottom',
				...
				ctor: '_Tuple2',
				_0: 'border-top',
				_1: selected ? A2(_elm_lang$core$Basics_ops['++'], 'solid 2px ', _user$project$View_Styles$selectColor) : 'none'
			},
				{
				ctor: '_Tuple2',
				_0: 'border-left',
...
var _user$project$View_Styles$inputTextColor = '#333';
var _user$project$View_Styles$input = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'color', _1: _user$project$View_Styles$inputTextColor},
		{ctor: '_Tuple2', _0: 'width', _1: '100%'},
		{ctor: '_Tuple2', _0: 'height', _1: '30px'},
		{ctor: '_Tuple2', _0: 'background-color', _1: '#fff'},
		{ctor: '_Tuple2', _0: 'box-shadow', _1: 'inset 0 1px 2px rgba(0,0,0,0.075)'},
		{ctor: '_Tuple2', _0: 'border', _1: '1px solid #ddd'},
		{ctor: '_Tuple2', _0: 'padding', _1: '6px 12px'},
		{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
		{ctor: '_Tuple2', _0: 'font-size', _1: '13px'}
	]);
var _user$project$View_Styles$pasteFromSpreadsheetInput = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$input,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'display', _1: 'block'},
			{ctor: '_Tuple2', _0: 'line-height', _1: '30px'},
...
var _user$project$View_Styles$floorNameInput = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$input,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View_Styles$floorOrdInput = _user$project$View_Styles$floorNameInput;
var _user$project$View_Styles$realSizeInput = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$input,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View_Styles$formInput = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$input,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'padding', _1: '7px 8px'},
			{ctor: '_Tuple2', _0: 'vertical-align', _1: 'middle'},
			{ctor: '_Tuple2', _0: 'font-size', _1: '13px'},
			{ctor: '_Tuple2', _0: 'margin-top', _1: '5px'},
			{ctor: '_Tuple2', _0: 'margin-bottom', _1: '15px'}
		]));
var _user$project$View_Styles$searchBox = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$input,
	_elm_lang$core$Native_List.fromArray(
		[
			...
			{ctor: '_Tuple2', _0: 'color', _1: _user$project$View_Styles$inputTextColor},
			{ctor: '_Tuple2', _0: 'border-radius', _1: '17px'},
			{ctor: '_Tuple2', _0: 'outline', _1: 'none'}
		]));
var _user$project$View_Styles$invertedTextColor = '#fff';
var _user$project$View_Styles$modeSelectionViewEach = function (selected) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'},
			...
			ctor: '_Tuple2',
			_0: 'background-color',
			_1: selected ? _user$project$View_Styles$selectColor : 'inherit'
		},
			{
			ctor: '_Tuple2',
			_0: 'color',
			_1: selected ? _user$project$View_Styles$invertedTextColor : 'inherit'
		},
			{ctor: '_Tuple2', _0: 'flex-grow', _1: '1'}
		]);
};
var _user$project$View_Styles$prototypePreviewScroll = function (isLeft) {
	return A2(
		_elm_lang$core$List_ops['::'],
		{
			ctor: '_Tuple2',
			_0: isLeft ? 'left' : 'right',
			_1: '3px'
		},
		_elm_lang$core$Native_List.fromArray(
			[
				...
				{ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
				{ctor: '_Tuple2', _0: 'color', _1: _user$project$View_Styles$invertedTextColor},
				{ctor: '_Tuple2', _0: 'background-color', _1: '#ccc'},
				{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'}
			]));
};
var _user$project$View_Styles$primaryButton = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$button,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: 'rgb(100, 180, 85)'},
			{ctor: '_Tuple2', _0: 'color', _1: _user$project$View_Styles$invertedTextColor},
			{ctor: '_Tuple2', _0: 'border', _1: 'solid 1px rgb(100, 180, 85)'}
		]));
var _user$project$View_Styles$publishButton = A2(_elm_lang$core$Basics_ops['++'], _user$project$View_Styles$formControl, _user$project$View_Styles$primaryButton);
var _user$project$View_Styles$diffPopupConfirmButton = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$primaryButton,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin-left', _1: '20px'}
		]));
var _user$project$View_Styles$unsetRelatedPersonButtonHover = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'background-color', _1: '#a66'},
		{ctor: '_Tuple2', _0: 'color', _1: _user$project$View_Styles$invertedTextColor}
	]);
var _user$project$View_Styles$zIndex = {labelObject: '50', selectedDesk: '100', selectedLabelObject: '100', deskInput: '200', selectorRect: '300', floorInfo: '500', personDetailPopup: '550', subView: '600', candidatesView: '660', messageBar: '700', contextMenu: '800', modalBackground: '900', userMenuView: '1000'};
var _user$project$View_Styles$deskInput = function (_p9) {
	var _p10 = _p9;
	var h$ = A2(_elm_lang$core$Basics$max, _p10._3, 15);
	var w$ = A2(_elm_lang$core$Basics$max, _p10._2, 100);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$absoluteRect(
			{ctor: '_Tuple4', _0: _p10._0, _1: _p10._1, _2: w$, _3: h$}),
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_Styles$noPadding,
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.deskInput},
					{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'}
				])));
};
var _user$project$View_Styles$nameInputTextArea = F2(
	function (transitionDisabled, screenRect) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_Styles$deskInput(screenRect),
			A2(
				_user$project$View_Styles$transition,
				_elm_lang$core$Native_List.fromArray(
					['left']),
...
var _user$project$View_Styles$deskObject = F5(
	function (rect, backgroundColor, selected, isGhost, disableTransition) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_Styles$absoluteRect(rect),
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						{ctor: '_Tuple2', _0: 'background-color', _1: backgroundColor},
						{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
						{
						ctor: '_Tuple2',
						_0: 'z-index',
						_1: selected ? _user$project$View_Styles$zIndex.selectedDesk : ''
					},
						{ctor: '_Tuple2', _0: 'border-style', _1: 'solid'},
						{
						ctor: '_Tuple2',
						...
						ctor: '_Tuple2',
						_0: 'border-top-color',
						_1: selected ? _user$project$View_Styles$selectColor : 'rgba(100,100,100,0.3)'
					},
						{
						ctor: '_Tuple2',
						...
						_1: selected ? _user$project$View_Styles$selectColor : 'rgba(100,100,100,0.7)'
					},
						{
						ctor: '_Tuple2',
...
var _user$project$View_Styles$labelObject = F8(
	function (isEllipse, rect, backgroundColor, fontColor, selected, isGhost, rectVisible, disableTransition) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_Styles$absoluteRect(rect),
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'background-color',
						_1: (_elm_lang$core$Native_Utils.eq(backgroundColor, '') || _elm_lang$core$Native_Utils.eq(backgroundColor, 'transparent')) ? (rectVisible ? 'rgba(255,255,255,0.2)' : 'transparent') : backgroundColor
					},
						{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
						{ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
						{
						ctor: '_Tuple2',
						_0: 'z-index',
						_1: selected ? _user$project$View_Styles$zIndex.selectedLabelObject : _user$project$View_Styles$zIndex.labelObject
					},
						{
						ctor: '_Tuple2',
						_0: 'border-style',
						_1: rectVisible ? 'dashed' : 'none'
					},
						{
						ctor: '_Tuple2',
						_0: 'border-width',
...
var _user$project$View_Styles$selectorRect = F2(
	function (disableTransition, rect) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_Styles$absoluteRect(rect),
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.selectorRect},
						{ctor: '_Tuple2', _0: 'border-style', _1: 'solid'},
						{ctor: '_Tuple2', _0: 'border-width', _1: '2px'},
						{ctor: '_Tuple2', _0: 'border-color', _1: _user$project$View_Styles$selectColor}
					]),
...
var _user$project$View_Styles$subView = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.subView},
		{ctor: '_Tuple2', _0: 'width', _1: '320px'},
		{ctor: '_Tuple2', _0: 'background', _1: '#eee'},
		{ctor: '_Tuple2', _0: 'position', _1: 'relative'}
	]);
var _user$project$View_Styles$contextMenu = F3(
	function (_p12, _p11, rows) {
		var _p13 = _p12;
		var _p14 = _p11;
		var height = rows * 20;
		var y$ = A2(_elm_lang$core$Basics$min, _p13._1, _p14._1 - height);
		var width = 200;
		var x$ = A2(_elm_lang$core$Basics$min, _p13._0, _p14._0 - width);
		return _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'width',
				_1: _user$project$Util_StyleUtil$px(width)
			},
				{
				ctor: '_Tuple2',
				_0: 'left',
				_1: _user$project$Util_StyleUtil$px(x$)
			},
				{
				ctor: '_Tuple2',
				_0: 'top',
				_1: _user$project$Util_StyleUtil$px(y$)
			},
				{ctor: '_Tuple2', _0: 'position', _1: 'fixed'},
				{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.contextMenu},
				{ctor: '_Tuple2', _0: 'background-color', _1: '#fff'},
				{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
				{ctor: '_Tuple2', _0: 'border-style', _1: 'solid'},
...
var _user$project$View_Styles$userMenuView = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'background', _1: 'rgb(100, 100, 120)'},
		{ctor: '_Tuple2', _0: 'box-shadow', _1: 'rgba(0, 0, 0, 0.2) 0px 3px 4px inset'},
		{ctor: '_Tuple2', _0: 'padding', _1: '10px'},
		{
		ctor: '_Tuple2',
		_0: 'top',
		_1: _user$project$Util_StyleUtil$px(37)
	},
		{
		ctor: '_Tuple2',
		_0: 'width',
		_1: _user$project$Util_StyleUtil$px(150)
	},
		{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.userMenuView}
	]);
var _user$project$View_Styles$floorsInfoView = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'width', _1: 'calc(100% - 300px)'},
		{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.floorInfo}
	]);
var _user$project$View_Styles$subViewTab = F2(
	function (index, active) {
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'top',
				_1: _user$project$Util_StyleUtil$px(10 + (index * 130))
			},
				{ctor: '_Tuple2', _0: 'left', _1: '-30px'},
				{ctor: '_Tuple2', _0: 'width', _1: '30px'},
				{ctor: '_Tuple2', _0: 'height', _1: '120px'},
				{ctor: '_Tuple2', _0: 'padding-top', _1: '50px'},
				{
				ctor: '_Tuple2',
				_0: 'background-color',
				_1: active ? '#eee' : '#eee'
				...
				{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.subView},
				{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'},
				{ctor: '_Tuple2', _0: 'border-radius', _1: '8px 0 0 8px'},
				{
				ctor: '_Tuple2',
				_0: 'box-shadow',
				_1: active ? '' : 'inset -4px 0 4px rgba(0,0,0,0.03)'
			},
				{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'}
			]);
	});
var _user$project$View_Styles$modalBackground = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'background-color', _1: 'rgba(0,0,0,0.5)'},
		{ctor: '_Tuple2', _0: 'position', _1: 'fixed'},
		{ctor: '_Tuple2', _0: 'left', _1: '0'},
		{ctor: '_Tuple2', _0: 'right', _1: '0'},
		{ctor: '_Tuple2', _0: 'top', _1: '0'},
		{ctor: '_Tuple2', _0: 'bottom', _1: '0'},
		{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.modalBackground}
	]);
var _user$project$View_Styles$personDetailPopup = F3(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'height',
					_1: _user$project$Util_StyleUtil$px(height)
				},
					{
					ctor: '_Tuple2',
					_0: 'left',
					_1: _user$project$Util_StyleUtil$px(
						A2(_user$project$Model_ProfilePopupLogic$calcPopupLeftFromObjectCenter, width, _p16._0))
				},
					{
					ctor: '_Tuple2',
					_0: 'top',
					_1: _user$project$Util_StyleUtil$px(
						A2(_user$project$Model_ProfilePopupLogic$calcPopupTopFromObjectTop, height, _p16._1))
				},
					{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.personDetailPopup}
				]));
	});
var _user$project$View_Styles$personDetailPopupDefault = F3(
	function (width, height, _p17) {
		var _p18 = _p17;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_Styles$defaultPopup,
			A3(
				_user$project$View_Styles$personDetailPopup,
				width,
				height,
				{ctor: '_Tuple2', _0: _p18._0, _1: _p18._1}));
	});
var _user$project$View_Styles$personDetailPopupSmall = function (_p19) {
	var _p20 = _p19;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View_Styles$smallPopup,
		A3(
			_user$project$View_Styles$personDetailPopup,
			80,
			40,
...
var _user$project$View_Styles$candidatesViewContainer = F3(
	function (screenRectOfDesk, relatedPersonExists, candidateLength) {
		var totalHeight = (relatedPersonExists ? 160 : 0) + (_user$project$View_Styles$candidateItemHeight * candidateLength);
		var _p21 = screenRectOfDesk;
		var x = _p21._0;
		var y = _p21._1;
		var w = _p21._2;
		var h = _p21._3;
		var left = (x + A2(_elm_lang$core$Basics$max, w, 100)) + 15;
		var top = A2(_elm_lang$core$Basics$max, 10, y - ((totalHeight / 2) | 0));
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Native_List.fromArray(
				[
					...
					{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.candidatesView}
				]),
			_user$project$View_Styles$shadow);
	});
var _user$project$View_Styles$messageBar = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'color', _1: _user$project$View_Styles$invertedTextColor},
		{ctor: '_Tuple2', _0: 'width', _1: '100%'},
		{ctor: '_Tuple2', _0: 'z-index', _1: _user$project$View_Styles$zIndex.messageBar},
		{ctor: '_Tuple2', _0: 'padding', _1: '5px 10px'},
		{ctor: '_Tuple2', _0: 'transition', _1: 'height'},
		{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
		{ctor: '_Tuple2', _0: 'transition', _1: 'opacity 0.8s linear'}
	]);
var _user$project$View_Styles$successBar = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$messageBar,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: '#4c5'},
			{ctor: '_Tuple2', _0: 'opacity', _1: '1'}
		]));
var _user$project$View_Styles$errorBar = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$messageBar,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: '#d45'},
			{ctor: '_Tuple2', _0: 'opacity', _1: '1'}
		]));
var _user$project$View_Styles$noneBar = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$View_Styles$messageBar,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View_Icons$userMenuToggle = function (open) {
	return A2(
		open ? _jystic$elm_font_awesome$FontAwesome$caret_up : _jystic$elm_font_awesome$FontAwesome$caret_down,
		_elm_lang$core$Color$white,
		16);
};
var _user$project$View_Icons$headerIconColor = _elm_lang$core$Color$white;
var _user$project$View_Icons$editingToggle = A2(_jystic$elm_font_awesome$FontAwesome$pencil, _user$project$View_Icons$headerIconColor, 22);
var _user$project$View_Icons$printButton = A2(_jystic$elm_font_awesome$FontAwesome$print, _user$project$View_Icons$headerIconColor, 22);
var _user$project$View_Icons$personNotMatched = function (ratio) {
	return A2(
		_jystic$elm_font_awesome$FontAwesome$question,
		_elm_lang$core$Color$white,
		_elm_lang$core$Basics$floor(18 * ratio));
};
var _user$project$View_Icons$personMatched = function (ratio) {
	return A2(
		_jystic$elm_font_awesome$FontAwesome$check,
		_elm_lang$core$Color$white,
		_elm_lang$core$Basics$floor(18 * ratio));
};
var _user$project$View_Icons$modeColor = A3(_elm_lang$core$Color$rgb, 90, 90, 90);
var _user$project$View_Icons$mode = F2(
	function (f, selected) {
		return A2(
			f,
			selected ? _elm_lang$core$Color$white : _user$project$View_Icons$modeColor,
			24);
	});
var _user$project$View_Icons$selectMode = _user$project$View_Icons$mode(_jystic$elm_font_awesome$FontAwesome$mouse_pointer);
var _user$project$View_Icons$penMode = _user$project$View_Icons$mode(_jystic$elm_font_awesome$FontAwesome$pencil);
var _user$project$View_Icons$stampMode = _user$project$View_Icons$mode(_jystic$elm_font_awesome$FontAwesome$th_large);
var _user$project$View_Icons$labelMode = _user$project$View_Icons$mode(_jystic$elm_font_awesome$FontAwesome$font);
var _user$project$View_Icons$defaultColor = A3(_elm_lang$core$Color$rgb, 140, 140, 140);
var _user$project$View_Icons$popupClose = A2(_jystic$elm_font_awesome$FontAwesome$close, _user$project$View_Icons$defaultColor, 18);
var _user$project$View_Icons$searchTab = A2(_jystic$elm_font_awesome$FontAwesome$search, _user$project$View_Icons$defaultColor, 20);
var _user$project$View_Icons$editTab = A2(_jystic$elm_font_awesome$FontAwesome$pencil, _user$project$View_Icons$defaultColor, 20);
var _user$project$View_Icons$proplabelColor = _user$project$View_Icons$defaultColor;
var _user$project$View_Icons$backgroundColorPropLabel = A2(_jystic$elm_font_awesome$FontAwesome$th_large, _user$project$View_Icons$proplabelColor, 12);
var _user$project$View_Icons$colorPropLabel = A2(_jystic$elm_font_awesome$FontAwesome$font, _user$project$View_Icons$proplabelColor, 12);
var _user$project$View_Icons$shapePropLabel = A2(_jystic$elm_font_awesome$FontAwesome$star_o, _user$project$View_Icons$proplabelColor, 12);
var _user$project$View_Icons$fontSizePropLabel = A2(_jystic$elm_font_awesome$FontAwesome$font, _user$project$View_Icons$proplabelColor, 12);
var _user$project$View_Icons$shapeRectangle = A2(_jystic$elm_font_awesome$FontAwesome$square, _user$project$View_Icons$defaultColor, 20);
var _user$project$View_Icons$shapeEllipse = A2(_jystic$elm_font_awesome$FontAwesome$circle, _user$project$View_Icons$defaultColor, 20);
var _user$project$View_Icons$searchResultItemPerson = A2(_jystic$elm_font_awesome$FontAwesome$user, _user$project$View_Icons$defaultColor, 20);
var _user$project$View_Icons$personDetailPopupPersonTel = A2(_jystic$elm_font_awesome$FontAwesome$phone, _user$project$View_Icons$defaultColor, 16);
var _user$project$View_Icons$personDetailPopupPersonMail = A2(_jystic$elm_font_awesome$FontAwesome$envelope, _user$project$View_Icons$defaultColor, 16);

var _user$project$Component_Header$userName = function (user) {
	var _p0 = user;
	switch (_p0.ctor) {
		case 'Admin':
			return _p0._0.name;
...
var _user$project$Component_Header$greetingForPerson = F2(
	function (person, menuOpened) {
		var image = function () {
			var _p1 = person.image;
			if (_p1.ctor === 'Just') {
				return A2(
					_elm_lang$html$Html$img,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$greetingImage),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$userMenuToggle)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					image,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$greetingName)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$userMenuToggleIcon)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$View_Icons$userMenuToggle(menuOpened)
						]))
				]));
	});
var _user$project$Component_Header$greeting = F2(
	function (user, menuOpened) {
		var _p2 = user;
		switch (_p2.ctor) {
			case 'Guest':
				return _elm_lang$html$Html$text('');
			case 'Admin':
				return A2(_user$project$Component_Header$greetingForPerson, _p2._0, menuOpened);
			default:
				return A2(_user$project$Component_Header$greetingForPerson, _p2._0, menuOpened);
		}
	});
var _user$project$Component_Header$editingToggleView = F3(
	function (onToggleEditing, lang, editing) {
		return A4(
			_jinjor$elm_inline_hover$InlineHover$hover,
			_user$project$View_Styles$hoverHeaderIconHover,
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(onToggleEditing),
					_elm_lang$html$Html_Attributes$style(
					_user$project$View_Styles$editingToggleContainer(editing))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$editingToggleIcon)
						]),
					_elm_lang$core$Native_List.fromArray(
						[_user$project$View_Icons$editingToggle])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$editingToggleText)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_user$project$Model_I18n$edit(lang))
						]))
				]));
	});
var _user$project$Component_Header$printButtonView = F3(
	function (onTogglePrintView, lang, printMode) {
		return A4(
			_jinjor$elm_inline_hover$InlineHover$hover,
			_user$project$View_Styles$hoverHeaderIconHover,
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(onTogglePrintView),
					_elm_lang$html$Html_Attributes$style(
					_user$project$View_Styles$editingToggleContainer(false))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[_user$project$View_Icons$printButton])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							printMode ? _user$project$Model_I18n$close(lang) : _user$project$Model_I18n$print(lang))
						]))
				]));
	});
var _user$project$Component_Header$signOut = F2(
	function (onSignOutClicked, lang) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$logout),
					_elm_lang$html$Html_Events$onClick(onSignOutClicked)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(
					_user$project$Model_I18n$signOut(lang))
				]));
	});
var _user$project$Component_Header$signIn = F2(
	function (onSignInClicked, lang) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$login),
					_elm_lang$html$Html_Events$onClick(onSignInClicked)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(
					_user$project$Model_I18n$signIn(lang))
				]));
	});
var _user$project$Component_Header$printButton = F3(
	function (onTogglePrintView, lang, user) {
		return _user$project$Model_User$isGuest(user) ? _elm_lang$html$Html$text('') : A3(_user$project$Component_Header$printButtonView, onTogglePrintView, lang, false);
	});
var _user$project$Component_Header$editingToggle = F4(
	function (onToggleEditing, lang, user, editing) {
		return _user$project$Model_User$isGuest(user) ? _elm_lang$html$Html$text('') : A3(_user$project$Component_Header$editingToggleView, onToggleEditing, lang, editing);
	});
var _user$project$Component_Header$menu = function (children) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$headerMenu)
			]),
		children);
};
var _user$project$Component_Header$langSelectView = F2(
	function (onSelectLang, lang) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$langSelectView)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(
							_user$project$View_Styles$langSelectViewItem(
								_elm_lang$core$Native_Utils.eq(lang, _user$project$Model_I18n$JA))),
							_elm_lang$html$Html_Events$onClick(
							onSelectLang(_user$project$Model_I18n$JA))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('日本語')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(
							_user$project$View_Styles$langSelectViewItem(
								_elm_lang$core$Native_Utils.eq(lang, _user$project$Model_I18n$EN))),
							_elm_lang$html$Html_Events$onClick(
							onSelectLang(_user$project$Model_I18n$EN))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('English')
						]))
				]));
	});
var _user$project$Component_Header$userMenuView = function (context) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$userMenuView)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_user$project$Component_Header$langSelectView, context.onSelectLang, context.lang),
				A2(_user$project$Component_Header$signOut, context.onSignOutClicked, context.lang)
			]));
};
var _user$project$Component_Header$viewPrintMode = function (context) {
	return A2(
		_elm_lang$html$Html$header,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$header)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$h1)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(context.title)
					])),
				_user$project$Component_Header$menu(
				_elm_lang$core$Native_List.fromArray(
					[
						A3(_user$project$Component_Header$printButtonView, context.onTogglePrintView, context.lang, true)
					]))
			]));
};
var _user$project$Component_Header$update = F2(
	function (action, menuOpened) {
		var _p3 = action;
		return _elm_lang$core$Basics$not(menuOpened);
	});
var _user$project$Component_Header$init = false;
var _user$project$Component_Header$Context = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {onSignInClicked: a, onSignOutClicked: b, onToggleEditing: c, onTogglePrintView: d, onSelectLang: e, onUpdate: f, title: g, lang: h, user: i, editing: j, printMode: k};
										};
									};
								};
							};
...
var _user$project$Component_Header$ToggleUserMenu = {ctor: 'ToggleUserMenu'};
var _user$project$Component_Header$userMenuToggle = F3(
	function (onUpdate, user, menuOpened) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					onUpdate(_user$project$Component_Header$ToggleUserMenu))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$Component_Header$greeting, user, menuOpened)
				]));
	});
var _user$project$Component_Header$normalMenu = F2(
	function (context, menuOpened) {
		return _user$project$Component_Header$menu(
			function () {
				var _p4 = context.user;
				if (_p4.ctor === 'Just') {
					var _p5 = _p4._0;
					return A2(
						_elm_lang$core$List_ops['::'],
						A4(_user$project$Component_Header$editingToggle, context.onToggleEditing, context.lang, _p5, context.editing),
						A2(
							_elm_lang$core$List_ops['::'],
							A3(_user$project$Component_Header$printButton, context.onTogglePrintView, context.lang, _p5),
							_elm_lang$core$Native_Utils.eq(_p5, _user$project$Model_User$Guest) ? _elm_lang$core$Native_List.fromArray(
								[
									A2(_user$project$Component_Header$signIn, context.onSignInClicked, context.lang)
								]) : _elm_lang$core$Native_List.fromArray(
								[
									A3(_user$project$Component_Header$userMenuToggle, context.onUpdate, _p5, menuOpened),
									menuOpened ? _user$project$Component_Header$userMenuView(context) : _elm_lang$html$Html$text('')
								])));
				} else {
					return _elm_lang$core$Native_List.fromArray(
						[]);
...
var _user$project$Component_Header$view = F2(
	function (context, state) {
		return context.printMode ? _user$project$Component_Header$viewPrintMode(context) : A2(
			_elm_lang$html$Html$header,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$header)
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$style(_user$project$View_Styles$headerLink),
					...
					A2(_user$project$Component_Header$normalMenu, context, state)
				]));
	});

var _user$project$Page_Master$update = F3(
	function (removeToken, message, model) {
		var _p0 = message;
		if (_p0.ctor === 'NoOp') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
			...
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						headerState: A2(_user$project$Component_Header$update, _p0._0, model.headerState)
					}),
				_elm_lang$core$Native_List.fromArray(
					[]));
		}
	});
var _user$project$Page_Master$init = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			accountServiceRoot: _p2.accountServiceRoot,
			title: _p2.title,
			error: _elm_lang$core$Maybe$Nothing,
			headerState: _user$project$Component_Header$init,
			lang: _elm_lang$core$Native_Utils.eq(_p2.lang, 'ja') ? _user$project$Model_I18n$JA : _user$project$Model_I18n$EN
		},
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Page_Master$removeToken = _elm_lang$core$Native_Platform.outgoingPort(
	'removeToken',
	function (v) {
		return {};
	});
var _user$project$Page_Master$tokenRemoved = _elm_lang$core$Native_Platform.incomingPort(
	'tokenRemoved',
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _user$project$Page_Master$Model = F5(
	function (a, b, c, d, e) {
		return {accountServiceRoot: a, title: b, error: c, headerState: d, lang: e};
	});
var _user$project$Page_Master$Flags = F5(
	function (a, b, c, d, e) {
		return {apiRoot: a, accountServiceRoot: b, authToken: c, title: d, lang: e};
	});
var _user$project$Page_Master$UpdateHeaderState = function (a) {
	return {ctor: 'UpdateHeaderState', _0: a};
};
var _user$project$Page_Master$NoOp = {ctor: 'NoOp'};
var _user$project$Page_Master$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Component_Header$view,
				{
					onSignInClicked: _user$project$Page_Master$NoOp,
					onSignOutClicked: _user$project$Page_Master$NoOp,
					onToggleEditing: _user$project$Page_Master$NoOp,
					onTogglePrintView: _user$project$Page_Master$NoOp,
					onSelectLang: function (_p3) {
						return _user$project$Page_Master$NoOp;
					},
					onUpdate: _user$project$Page_Master$UpdateHeaderState,
					title: model.title,
					lang: _user$project$Model_I18n$EN,
...
var _user$project$Page_Master$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _user$project$Page_Master$init,
			view: _user$project$Page_Master$view,
			update: _user$project$Page_Master$update(_user$project$Page_Master$removeToken),
			subscriptions: function (_p4) {
				return _elm_lang$core$Platform_Sub$none;
			}
		}),
	flags: A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'accountServiceRoot', _elm_lang$core$Json_Decode$string),
		function (accountServiceRoot) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'apiRoot', _elm_lang$core$Json_Decode$string),
				function (apiRoot) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
									...
									return A2(
										...
										function (title) {
											return _elm_lang$core$Json_Decode$succeed(
												{accountServiceRoot: accountServiceRoot, apiRoot: apiRoot, authToken: authToken, lang: lang, title: title});
										});
								});
						});
				});
...
var Elm = {};
Elm['Page'] = Elm['Page'] || {};
Elm['Page']['Master'] = Elm['Page']['Master'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Page']['Master'], 'Page.Master', typeof _user$project$Page_Master$main === 'undefined' ? null : _user$project$Page_Master$main);
