...
Elm.Util = Elm.Util || {};
Elm.Util.File = Elm.Util.File || {};
Elm.Util.File.make = function (_elm) {
   "use strict";
   _elm.Util = _elm.Util || {};
   _elm.Util.File = _elm.Util.File || {};
   if (_elm.Util.File.values) return _elm.Util.File.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var getSizeOfImage = $Native$File.getSizeOfImage;
   var length = function (_p0) {
      var _p1 = _p0;
      return $Native$File.length(_p1._0);
   };
   var Unexpected = function (a) {
      return {ctor: "Unexpected",_0: a};
   };
   var readAsDataURL = function (_p2) {
      var _p3 = _p2;
      var _p4 = _p3._0;
      return A2($Task.mapError,
      $Basics.always(Unexpected($Basics.toString(_p4))),
      $Native$File.readAsDataURL(_p4));
   };
   var File = function (a) {    return {ctor: "File",_0: a};};
   var getAt = F2(function (index,fileList) {
      var _p5 = fileList;
      return _U.cmp(0,index) < 1 && _U.cmp(index,
      length(fileList)) < 0 ? $Maybe.Just(File(A2($Native$File.getAt,
      index,
      _p5._0))) : $Maybe.Nothing;
   });
   ...
   $Json$Decode.value));
   return _elm.Util.File.values = {_op: _op
                                  ,FileList: FileList
                                  ,File: File
...
Elm.Floor.make = function (_elm) {
   ...
   var setLocalFile$ = F4(function (id,file,dataURL,model) {
      var _p3 = $Util$File.getSizeOfImage(dataURL);
      var width = _p3._0;
      var height = _p3._1;
      return _U.update(model,
      {width: width
      ,height: height
      ,imageSource: A3(LocalFile,id,file,dataURL)});
   });
...
Elm.Util.HttpUtil.make = function (_elm) {
   ...
   $Util$File = Elm.Util.File.make(_elm);
   var _op = {};
   var sendJson = F4(function (verb,decoder,url,body) {
   ...
   var postJson = sendJson("POST");
   var putJson = sendJson("PUT");
   var sendFile = F3(function (method,url,_p0) {
      var _p1 = _p0;
      return A3($Native$HttpUtil.sendFile,method,url,_p1._0);
   });
   var goTo = $Native$HttpUtil.goTo;
   var reload = $Native$HttpUtil.reload;
   return _elm.Util.HttpUtil.values = {_op: _op
                                      ,reload: reload
                                      ,goTo: goTo
                                      ,sendFile: sendFile
                                      ,sendJson: sendJson
...
Elm.API.make = function (_elm) {
   ...
   var decodeAlways = A2($Json$Decode.andThen,
   $Json$Decode.value,
   function (_p0) {
      return $Json$Decode.succeed({ctor: "_Tuple0"});
   });
   ...
   var listToTuple2 = function (list) {
      var _p1 = list;
   ...
   var decodeFloor = A8($Json$Decode.object7,
   F7(function (id,name,equipments,width,height,realSize,src) {
      return {id: id
             ,name: name
             ,equipments: equipments
             ,width: width
             ...
             ,realSize: A2($Maybe.andThen,realSize,listToTuple2)};
   }),
   A2($Json$Decode._op[":="],"id",$Json$Decode.string),
   A2($Json$Decode._op[":="],"name",$Json$Decode.string),
   A2($Json$Decode._op[":="],
   ...
   var encodeLogin = F2(function (id,pass) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                          ,_0: "id"
                                          ,_1: $Json$Encode.string(id)}
                                         ,{ctor: "_Tuple2",_0: "pass",_1: $Json$Encode.string(pass)}]));
   });
   var serializeLogin = F2(function (id,pass) {
      return A2($Json$Encode.encode,0,A2(encodeLogin,id,pass));
   });
   var login = F2(function (id,pass) {
      return A3($Util$HttpUtil.postJson,
      decodeAlways,
      "/api/v1/login",
      $Http.string(A2(serializeLogin,id,pass)));
   });
   var encodeEquipment = function (_p2) {
      var _p3 = _p2;
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                          ,_0: "id"
                                          ,_1: $Json$Encode.string(_p3._0)}
                                         ,{ctor: "_Tuple2",_0: "type",_1: $Json$Encode.string("desk")}
                                         ,{ctor: "_Tuple2",_0: "x",_1: $Json$Encode.$int(_p3._1._0)}
                                         ,{ctor: "_Tuple2",_0: "y",_1: $Json$Encode.$int(_p3._1._1)}
                                         ,{ctor: "_Tuple2",_0: "width",_1: $Json$Encode.$int(_p3._1._2)}
                                         ,{ctor: "_Tuple2",_0: "height",_1: $Json$Encode.$int(_p3._1._3)}
                                         ,{ctor: "_Tuple2",_0: "color",_1: $Json$Encode.string(_p3._2)}
                                         ,{ctor: "_Tuple2"
                                          ,_0: "name"
                                          ,_1: $Json$Encode.string(_p3._3)}]));
   };
   var encodeFloor = function (floor) {
      var src = function () {
         var _p4 = floor.imageSource;
         switch (_p4.ctor)
         {case "LocalFile": return $Json$Encode.string(_p4._0);
            case "URL": return $Json$Encode.string(_p4._0);
      ...
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                         ...
                                         ,{ctor: "_Tuple2"
                                          ,_0: "realSize"
                                          ,_1: function () {
                                             var _p5 = floor.realSize;
                                             if (_p5.ctor === "Just") {
                                                   return $Json$Encode.list(_U.list([$Json$Encode.$int(_p5._0._0)
                                                                                    ,$Json$Encode.$int(_p5._0._1)]));
                                                } else {
   ...
   var saveEditingFloor = function (floor) {
      return A3($Util$HttpUtil.putJson,
      A2($Json$Decode.map,
   ...
   var publishEditingFloor = function (floor) {
      return A3($Util$HttpUtil.postJson,
      A2($Json$Decode.map,
      $Basics.always({ctor: "_Tuple0"}),
      $Json$Decode.value),
      A2($Basics._op["++"],"/api/v1/floor/",floor.id),
      $Http.string(serializeFloor(floor)));
   };
...
Elm.Util.Keys.make = function (_elm) {
   ...
   function (value) {
      ...
      A2($Json$Decode.at,_U.list(["keyCode"]),$Json$Decode.$int),
      value);
      if (_p0.ctor === "Ok") {
            return $Maybe.Just(_p0._0);
         } else {
   ...
   var inputs = _U.list([A2($Signal.map,KeyCtrl,$Keyboard.ctrl)
                        ...
                        ,A2($Signal.map,Enter,$Keyboard.isDown(13))
                        ,A2($Signal.map,
                        KeyC,
                        ...
                        function (keyCode) {
                           ...
                           $Char.toCode(_U.chr("Y"))) ? KeyY : _U.eq(keyCode,
                           $Char.toCode(_U.chr("Z"))) ? KeyZ : _U.eq(keyCode,
                           37) ? KeyLeftArrow : _U.eq(keyCode,
                           38) ? KeyUpArrow : _U.eq(keyCode,
                           39) ? KeyRightArrow : _U.eq(keyCode,40) ? KeyDownArrow : Other;
                        },
                        downs)]);
...
Elm.Util.HtmlUtil.make = function (_elm) {
   ...
   $Util$File = Elm.Util.File.make(_elm);
   var _op = {};
   var fileLoadButton = F3(function (address,styles,text) {
      ...
      _U.list([$Html.text(text)
              ...
              _U.list([$Html$Attributes.type$("file")
                      ...
                      ,A3($Html$Events.on,
                      "change",
                      $Util$File.decodeFile,
                      $Signal.message(address))]),
              _U.list([]))]));
   });
   var form$ = F4(function (address,action,attribtes,children) {
      return A2($Html.form,
      A2($Basics._op["++"],
      _U.list([$Html$Attributes.action("javascript:void(0);")
              ,$Html$Attributes.method("POST")
              ,A2($Html$Events.onSubmit,address,action)]),
      attribtes),
      children);
   });
   ...
   function (value) {
      return !_U.eq(value,
      0) ? $Json$Decode.succeed(value) : $Json$Decode.fail("Wheel of 0");
   });
   ...
   var onContextMenu$ = F2(function (address,e) {
      return A4($Html$Events.onWithOptions,
      "contextmenu",
      {stopPropagation: true,preventDefault: true},
      $Json$Decode.value,
      $Basics.always(A2($Signal.message,address,e)));
   });
   ...
   var onClick$ = F2(function (address,e) {
      return A4($Html$Events.onWithOptions,
      "click",
      {stopPropagation: true,preventDefault: true},
      $Json$Decode.value,
   ...
   var onDblClick$ = F2(function (address,e) {
      return A4($Html$Events.onWithOptions,
      "dblclick",
      {stopPropagation: true,preventDefault: true},
      $Json$Decode.value,
   ...
   var onMouseDown$ = F2(function (address,e) {
      return A4($Html$Events.onWithOptions,
      "mousedown",
      {stopPropagation: true,preventDefault: true},
      $Json$Decode.value,
   ...
   var mouseDownDefence = F2(function (address,e) {
      return A2(onMouseDown$,address,e);
   });
   var onMouseUp$ = F2(function (address,e) {
      return A3($Html$Events.on,
      "mouseup",
      $Json$Decode.value,
      $Basics.always(A2($Signal.message,address,e)));
   });
   var onMouseLeave$ = F2(function (address,e) {
      return A4($Html$Events.onWithOptions,
      "mouseleave",
      {stopPropagation: true,preventDefault: true},
      $Json$Decode.value,
   ...
   var onMouseEnter$ = F2(function (address,e) {
      return A4($Html$Events.onWithOptions,
      "mouseenter",
      {stopPropagation: true,preventDefault: true},
      $Json$Decode.value,
   ...
   var onSubmit$ = F2(function (address,e) {
      return A4($Html$Events.onWithOptions,
      "onsubmit",
   ...
   var decodeKeyCode = A2($Json$Decode.at,
   _U.list(["keyCode"]),
   $Json$Decode.$int);
   ...
   var decodeClientXY = A3($Json$Decode.object2,
   F2(function (v0,v1) {
      return {ctor: "_Tuple2",_0: v0,_1: v1};
   }),
   ...
   return _elm.Util.HtmlUtil.values = {_op: _op
                                      ...
                                      ,Unexpected: Unexpected
                                      ,decodeClientXY: decodeClientXY
                                      ,decodeKeyCode: decodeKeyCode
                                      ,focus: focus
                                      ,blur: blur
                                      ,locationHash: locationHash
                                      ,onSubmit$: onSubmit$
...
Elm.Model.make = function (_elm) {
   ...
   var _op = {};
   var screenToImageWithOffset = F3(function (scale,_p1,_p0) {
      var _p2 = _p1;
      var _p3 = _p0;
      return {ctor: "_Tuple2"
             ,_0: A2($Scale.screenToImage,scale,_p2._0) - _p3._0
             ,_1: A2($Scale.screenToImage,scale,_p2._1) - _p3._1};
   });
   var stampCandidates = function (model) {
      ...
      if (_p4.ctor === "Stamp") {
            ...
            var x2 = _p5._0;
            var y2 = _p5._1;
            var _p6 = model.offset;
            var offsetX = _p6._0;
            var offsetY = _p6._1;
            var _p7 = A3(screenToImageWithOffset,
            model.scale,
            {ctor: "_Tuple2",_0: x2,_1: y2},
            {ctor: "_Tuple2",_0: offsetX,_1: offsetY});
            var x2$ = _p7._0;
            var y2$ = _p7._1;
            var prototype = $Prototypes.selectedPrototype(model.prototypes);
            var _p8 = prototype;
            var prototypeId = _p8._0;
            var color = _p8._1;
            var name = _p8._2;
            var deskSize = _p8._3;
            var _p9 = model.draggingContext;
            if (_p9.ctor === "StampFromScreenPos" && _p9._0.ctor === "_Tuple2")
            {
                  var _p10 = A3(screenToImageWithOffset,
                  model.scale,
                  ...
                  var _p11 = deskSize;
                  var deskWidth = _p11._0;
                  var deskHeight = _p11._1;
                  var _p12 = A2($EquipmentsOperation.fitToGrid,
                  model.gridSize,
                  {ctor: "_Tuple2"
                  ,_0: x2$ - (deskWidth / 2 | 0)
   ...
   var temporaryPen = F2(function (model,from) {
      var name = "";
      var color = "#fff";
      var _p13 = model.offset;
      var offsetX = _p13._0;
      var offsetY = _p13._1;
      var _p14 = A2($EquipmentsOperation.fitToGrid,
      model.gridSize,
      A3(screenToImageWithOffset,
      model.scale,
      from,
      {ctor: "_Tuple2",_0: offsetX,_1: offsetY}));
      var left = _p14._0;
      var top = _p14._1;
      var _p15 = A2($EquipmentsOperation.fitToGrid,
      model.gridSize,
      A3(screenToImageWithOffset,
      model.scale,
      model.pos,
      ...
      return _U.cmp(width,0) > 0 && _U.cmp(height,
      0) > 0 ? $Maybe.Just({ctor: "_Tuple3"
                           ,_0: color
                           ,_1: name
                           ,_2: {ctor: "_Tuple4"
                                ,_0: left
   ...
   var primarySelectedEquipment = function (model) {
      var _p16 = model.selectedEquipments;
      if (_p16.ctor === "::") {
            return A2($EquipmentsOperation.findEquipmentById,
            ...
            var toBeSelected = function () {
               if (model.keys.shift) return A2($List.map,
                  ...
                  floor.equipments)); else {
                     var _p18 = A3($EquipmentsOperation.nearest,
                     direction,
                     _p19,
                     floor.equipments);
                     if (_p18.ctor === "Just") {
                           var newEquipments = _U.list([_p18._0]);
   ...
   var updateByMoveEquipmentEnd = F4(function (id,
   _p21,
   _p20,
   model) {
      var _p22 = _p21;
      ...
      model.scale,
      {ctor: "_Tuple2",_0: _p23._0 - _p22._0,_1: _p23._1 - _p22._1});
      return !_U.eq(shift,
      ...
      model.selectedEquipments,
      model.gridSize,
      shift))}) : $Basics.not(model.keys.ctrl) && $Basics.not(model.keys.shift) ? _U.update(model,
      {selectedEquipments: _U.list([id])}) : model;
   });
   var updateByKeyAction = F2(function (action,model) {
      var _p24 = {ctor: "_Tuple2",_0: model.keys.ctrl,_1: action};
      _v9_10: do {
         if (_p24.ctor === "_Tuple2") {
               switch (_p24._1.ctor)
               {case "KeyC": if (_p24._0 === true && _p24._1._0 === true) {
                  ...
                  case "KeyV": if (_p24._0 === true && _p24._1._0 === true) {
                          var _p25 = A2($Util$IdGenerator.zipWithNewIds,
                          model.seed,
                          model.copiedEquipments);
                          var copiedIdsWithNewIds = _p25._0;
                          var newSeed = _p25._1;
                          var selected = A2($List.map,$Basics.snd,copiedIdsWithNewIds);
                          var base = function () {
                             var _p26 = model.selectorRect;
                             if (_p26.ctor === "Just") {
                                   return {ctor: "_Tuple2",_0: _p26._0._0,_1: _p26._0._1};
                                } else {
                  ...
                  case "KeyX": if (_p24._0 === true && _p24._1._0 === true) {
                          var newModel = _U.update(model,
                          {floor: A2($Util$UndoRedo.commit,
                          model.floor,
                  ...
                  case "KeyRightArrow": var newModel = A2(shiftSelectionToward,
                    ...
                    model);
                    return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
                  case "KeyDel": if (_p24._1._0 === true) {
                          var newModel = _U.update(model,
                          {floor: A2($Util$UndoRedo.commit,
                          model.floor,
                          $Floor.$delete(model.selectedEquipments))});
   ...
   var SelectIsland = function (a) {
      return {ctor: "SelectIsland",_0: a};
   };
   var ShowContextMenuOnEquipment = function (a) {
      return {ctor: "ShowContextMenuOnEquipment",_0: a};
   };
   ...
   var SelectColor = function (a) {
      return {ctor: "SelectColor",_0: a};
   };
   var KeysAction = function (a) {
      return {ctor: "KeysAction",_0: a};
   };
   var StartEditEquipment = function (a) {
      return {ctor: "StartEditEquipment",_0: a};
   };
   var MouseDownOnEquipment = function (a) {
      return {ctor: "MouseDownOnEquipment",_0: a};
   };
   var MouseDownOnCanvas = {ctor: "MouseDownOnCanvas"};
   var MouseUpOnCanvas = {ctor: "MouseUpOnCanvas"};
   ...
   var StampFromScreenPos = function (a) {
      return {ctor: "StampFromScreenPos",_0: a};
   };
   var PenFromScreenPos = function (a) {
      return {ctor: "PenFromScreenPos",_0: a};
   };
   ...
   var blurEffect = function (id) {
      return A3($Util$EffectsUtil.fromTask,
      function (_p29) {
         return Error(HtmlError(_p29));
      },
      $Basics.always(NoOp),
      $Util$HtmlUtil.blur(id));
   };
   var FileError = function (a) {
      return {ctor: "FileError",_0: a};
   };
   ...
   var saveFloorEffects = function (floor) {
      ...
      var firstTask = function () {
         var _p30 = floor.imageSource;
         if (_p30.ctor === "LocalFile") {
               return A2($API.saveEditingImage,_p30._0,_p30._1);
            } else {
               return $Task.succeed({ctor: "_Tuple0"});
            }
      }();
      return A3($Util$EffectsUtil.fromTask,
      function (_p31) {
         return Error(APIError(_p31));
      },
      $Basics.always(FloorSaved),
      A2($Task.andThen,firstTask,$Basics.always(secondTask)));
   };
   var publishFloorEffects = function (floor) {
      var secondTask = $API.publishEditingFloor(floor);
      var firstTask = function () {
         var _p32 = floor.imageSource;
         if (_p32.ctor === "LocalFile") {
               return A2($API.saveEditingImage,_p32._0,_p32._1);
            } else {
               return $Task.succeed({ctor: "_Tuple0"});
            }
      }();
      return A3($Util$EffectsUtil.fromTask,
      function (_p33) {
         return Error(APIError(_p33));
      },
      $Basics.always(FloorSaved),
      A2($Task.andThen,firstTask,$Basics.always(secondTask)));
   };
   var update = F2(function (action,model) {
      var _p34 = debugAction(action);
      switch (_p34.ctor)
      {case "NoOp": return {ctor: "_Tuple2"
                           ,_0: model
                           ,_1: $Effects.none};
         case "HashChange": var _p35 = _p34._0;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{hash: _p35})
                  ,_1: loadFloorEffects(_p35)};
         case "Init": return {ctor: "_Tuple2"
                             ,_0: model
                             ,_1: loadFloorEffects(model.hash)};
         case "FloorLoaded": var _p37 = _p34._0;
           var _p36 = $Floor.realSize(_p37);
           var realWidth = _p36._0;
           var realHeight = _p36._1;
           var newModel = _U.update(model,
           {floor: $Util$UndoRedo.init({data: _p37,update: $Floor.update})
         ...
         case "FloorSaved": var newModel = _U.update(model,
           ...
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "MoveOnCanvas": var _p38 = model.pos;
           var prevX = _p38._0;
           var prevY = _p38._1;
           var _p39 = {ctor: "_Tuple2",_0: _p34._0._0,_1: _p34._0._1 - 37};
           var x = _p39._0;
           var y = _p39._1;
           var model$ = _U.update(model,
           {pos: {ctor: "_Tuple2",_0: x,_1: y}});
           var newModel = function () {
              var _p40 = model.draggingContext;
              if (_p40.ctor === "ShiftOffsetPrevScreenPos") {
                    return _U.update(model$,
                    {offset: function () {
                       var _p41 = {ctor: "_Tuple2",_0: x - prevX,_1: y - prevY};
                       var dx = _p41._0;
                       var dy = _p41._1;
                       var _p42 = model.offset;
                       var offsetX = _p42._0;
                       var offsetY = _p42._1;
                       return {ctor: "_Tuple2"
         ...
         case "LeaveCanvas": var newModel = _U.update(model,
           {draggingContext: function () {
              var _p43 = model.draggingContext;
              if (_p43.ctor === "ShiftOffsetPrevScreenPos") {
                    return None;
                 } else {
           ...
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "MouseDownOnEquipment": var _p47 = _p34._0;
           var _p44 = model.pos;
           var clientX = _p44._0;
           var clientY = _p44._1;
           var newModel = _U.update(model,
           {selectedEquipments: function () {
              if (model.keys.ctrl) return A2($List.member,
                 _p47,
                 model.selectedEquipments) ? A2($List.filter,
                 F2(function (x,y) {    return !_U.eq(x,y);})(_p47),
                 model.selectedEquipments) : A2($List._op["::"],
                 _p47,
                 model.selectedEquipments); else if (model.keys.shift) {
                       ...
                       if (_p45.ctor === "_Tuple2" && _p45._0.ctor === "Just" && _p45._1.ctor === "Just")
                       {
                             ...
                             {ctor: "_Tuple2",_0: _p46,_1: _p45._0._0},
                             equipmentsExcept(_p46))));
                          } else {
                             return _U.list([_p47]);
                          }
                    } else if (A2($List.member,_p47,model.selectedEquipments))
                    return model.selectedEquipments; else return _U.list([_p47]);
           }()
           ,draggingContext: A2(MoveEquipment,
           _p47,
           {ctor: "_Tuple2",_0: clientX,_1: clientY})
           ,selectorRect: $Maybe.Nothing});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "MouseUpOnCanvas": var _p48 = model.pos;
           var clientX = _p48._0;
           var clientY = _p48._1;
           var _p49 = function () {
              var _p50 = model.draggingContext;
              _v18_4: do {
                 switch (_p50.ctor)
                 {case "MoveEquipment": if (_p50._1.ctor === "_Tuple2") {
                            var newModel = A4(updateByMoveEquipmentEnd,
                            _p50._0,
                            {ctor: "_Tuple2",_0: _p50._1._0,_1: _p50._1._1},
                            {ctor: "_Tuple2",_0: clientX,_1: clientY},
                            model);
                    ...
                    case "Selector": return {ctor: "_Tuple2"
                                            ...
                                            {selectorRect: function () {
                                               var _p51 = model.selectorRect;
                                               if (_p51.ctor === "Just" && _p51._0.ctor === "_Tuple4") {
                                                     var _p54 = _p51._0._1;
                                                     var _p53 = _p51._0._0;
                                                     var _p52 = {ctor: "_Tuple2"
                                                                ,_0: A2($Scale.screenToImage,model.scale,clientX) - _p53
                                                                ,_1: A2($Scale.screenToImage,model.scale,clientY) - _p54};
                                                     var w = _p52._0;
                                                     var h = _p52._1;
                                                     return $Maybe.Just({ctor: "_Tuple4"
                                                                        ,_0: _p53
                                            ...
                                            ,_1: $Effects.none};
                    case "StampFromScreenPos":
                    var _p55 = A2($Util$IdGenerator.zipWithNewIds,
                      model.seed,
                      stampCandidates(model));
                      var candidatesWithNewIds = _p55._0;
                      var newSeed = _p55._1;
                      ...
                      return {ctor: "_Tuple2"
                             ...
                             ,_1: effects};
                    case "PenFromScreenPos": if (_p50._0.ctor === "_Tuple2") {
                            var _p58 = function () {
                               var _p59 = A2(temporaryPen,
                               model,
                               {ctor: "_Tuple2",_0: _p50._0._0,_1: _p50._0._1});
                               if (_p59.ctor === "Just") {
                                     var _p60 = $Util$IdGenerator.$new(model.seed);
                                     var newId = _p60._0;
                                     var newSeed = _p60._1;
                                     var newFloor = A2($Util$UndoRedo.commit,
                                     model.floor,
                                     $Floor.create(_U.list([{ctor: "_Tuple4"
                                                            ,_0: newId
                                                            ,_1: {ctor: "_Tuple4"
                                                                 ,_0: _p59._0._2._0
                                                                 ,_1: _p59._0._2._1
                                     ...
                                     return {ctor: "_Tuple3"
                                            ,_0: newFloor
                                            ,_1: newSeed
                                            ,_2: saveFloorEffects($Util$UndoRedo.data(newFloor))};
                                  } else {
                                     return {ctor: "_Tuple3"
                                            ,_0: model.floor
                                            ,_1: model.seed
           ...
           return {ctor: "_Tuple2",_0: newModel,_1: effects};
         case "MouseDownOnCanvas": var _p61 = model.pos;
           var clientX = _p61._0;
           var clientY = _p61._1;
           var selectorRect = function () {
              var _p62 = model.editMode;
              if (_p62.ctor === "Select") {
                    var _p63 = A2($EquipmentsOperation.fitToGrid,
                    model.gridSize,
                    A3(screenToImageWithOffset,
                    model.scale,
                    {ctor: "_Tuple2",_0: clientX,_1: clientY},
           ...
           var draggingContext = function () {
              var _p64 = model.editMode;
              switch (_p64.ctor)
              {case "Stamp": return StampFromScreenPos({ctor: "_Tuple2"
                                                       ,_0: clientX
                                                       ,_1: clientY});
                 case "Pen": return PenFromScreenPos({ctor: "_Tuple2"
                                                     ,_0: clientX
                                                     ,_1: clientY});
                 default: return ShiftOffsetPrevScreenPos;}
           }();
           var model$ = function () {
              var _p65 = model.editingEquipment;
              if (_p65.ctor === "Just") {
                    return _U.update(model,
                    {floor: A2($Util$UndoRedo.commit,
                    model.floor,
                    A2($Floor.changeEquipmentName,_p65._0._0,_p65._0._1))});
                 } else {
                    return model;
                 }
           }();
         ...
         var _p66 = A2($EquipmentsOperation.findEquipmentById,
           $Util$UndoRedo.data(model.floor).equipments,
           _p34._0);
           if (_p66.ctor === "Just") {
                 var _p67 = _p66._0;
                 ...
                 {editingEquipment: $Maybe.Just({ctor: "_Tuple2"
                                                ,_0: $EquipmentsOperation.idOf(_p67)
                                                ,_1: $EquipmentsOperation.nameOf(_p67)})
                 ,contextMenu: NoContextMenu});
                 return {ctor: "_Tuple2"
                        ,_0: newModel
         ...
         case "SelectColor": var newModel = _U.update(model,
           ...
           _p34._0))});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "InputName": var _p70 = _p34._0;
           var newModel = _U.update(model,
           {editingEquipment: function () {
              var _p68 = model.editingEquipment;
              if (_p68.ctor === "Just") {
                    var _p69 = _p68._0._0;
                    return _U.eq(_p70,_p69) ? $Maybe.Just({ctor: "_Tuple2"
                                                          ,_0: _p70
                                                          ,_1: _p34._1}) : $Maybe.Just({ctor: "_Tuple2"
                                                                                       ,_0: _p69
                                                                                       ,_1: _p68._0._1});
                 } else {
                    return $Maybe.Nothing;
           ...
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "KeydownOnNameInput": var _p79 = _p34._0;
           var _p71 = function () {
              if (_U.eq(_p79,13) && $Basics.not(model.keys.ctrl)) {
                    var newModel = function () {
                       var _p72 = model.editingEquipment;
                       if (_p72.ctor === "Just") {
                             var _p77 = _p72._0._0;
                             var allEquipments = $Util$UndoRedo.data(model.floor).equipments;
                             var editingEquipment = function () {
                                var _p73 = A2($EquipmentsOperation.findEquipmentById,
                                allEquipments,
                                _p77);
                                if (_p73.ctor === "Just") {
                                      var _p76 = _p73._0;
                                      ...
                                      A2($List.filter,
                                      function (e) {
                                         return !_U.eq($EquipmentsOperation.idOf(e),_p77);
                                      },
                                      allEquipments));
                                      var _p74 = A3($EquipmentsOperation.nearest,
                                      $EquipmentsOperation.Down,
                                      _p76,
                                      island$);
                                      if (_p74.ctor === "Just") {
                                            var _p75 = _p74._0;
                                            return $Maybe.Just({ctor: "_Tuple2"
                                                               ,_0: $EquipmentsOperation.idOf(_p75)
                                                               ,_1: $EquipmentsOperation.nameOf(_p75)});
                                         } else {
                                            return $Maybe.Nothing;
                                         }
                                   } else {
                             ...
                             {floor: A2($Util$UndoRedo.commit,
                             model.floor,
                             A2($Floor.changeEquipmentName,_p77,_p72._0._1))
                    ...
                    return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
                 } else if (_U.eq(_p79,13)) {
                       var newModel = _U.update(model,
                       {editingEquipment: function () {
                          var _p78 = model.editingEquipment;
                          if (_p78.ctor === "Just") {
                                return $Maybe.Just({ctor: "_Tuple2"
                                                   ,_0: _p78._0._0
                                                   ,_1: A2($Basics._op["++"],_p78._0._1,"\n")});
                             } else {
                                return $Maybe.Nothing;
                             }
                       }()});
           ...
           var effects = _p71._1;
           return {ctor: "_Tuple2",_0: newModel,_1: effects};
         case "ShowContextMenuOnEquipment": var _p80 = model.pos;
           var clientX = _p80._0;
           var clientY = _p80._1;
           var newModel = _U.update(model,
           ...
           _p34._0)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "SelectIsland": var _p82 = _p34._0;
           var newModel = function () {
              var _p81 = A2($EquipmentsOperation.findEquipmentById,
              $Util$UndoRedo.data(model.floor).equipments,
              _p82);
              if (_p81.ctor === "Just") {
                    var island$ = A2($EquipmentsOperation.island,
                    ...
                    A2($List.filter,
                    function (e) {
                       return !_U.eq($EquipmentsOperation.idOf(e),_p82);
                    },
                    $Util$UndoRedo.data(model.floor).equipments));
                    return _U.update(model,
           ...
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "KeysAction": var _p83 = _p34._0;
           var model$ = _U.update(model,
           {keys: A2($Util$Keys.update,_p83,model.keys)});
           return A2(updateByKeyAction,_p83,model$);
         case "MouseWheel":
         var effects = A2($Util$EffectsUtil.fromTaskWithNoError,
           $Basics.always(ScaleEnd),
           $Task.sleep(200.0));
           var _p84 = model.offset;
           var offsetX = _p84._0;
           var offsetY = _p84._1;
           var newScale = _U.cmp(_p34._0,0) < 0 ? A2($Scale.update,
           $Scale.ScaleUp,
           ...
           var newOffset = function () {
              var y = A2($Scale.screenToImage,model.scale,clientY - 37);
              var x = A2($Scale.screenToImage,model.scale,clientX);
              return {ctor: "_Tuple2"
         ...
         case "ChangeMode": var newModel = _U.update(model,
           {editMode: _p34._0});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "LoadFile": var _p86 = A2($Util$File.getAt,0,_p34._0);
           if (_p86.ctor === "Just") {
                 var _p89 = _p86._0;
                 var _p87 = $Util$IdGenerator.$new(model.seed);
                 var id = _p87._0;
                 var newSeed = _p87._1;
                 var newModel = _U.update(model,{seed: newSeed});
                 var effects = A3($Util$EffectsUtil.fromTask,
                 function (_p88) {
                    return Error(FileError(_p88));
                 },
                 A2(GotDataURL,id,_p89),
                 $Util$File.readAsDataURL(_p89));
         ...
         case "GotDataURL": var newModel = _U.update(model,
           {floor: A2($Util$UndoRedo.commit,
           model.floor,
           A3($Floor.setLocalFile,_p34._0,_p34._1,_p34._2))});
           var effects = saveFloorEffects($Util$UndoRedo.data(newModel.floor));
           return {ctor: "_Tuple2",_0: newModel,_1: effects};
         case "PrototypesAction": var newModel = _U.update(model,
           {prototypes: A2($Prototypes.update,_p34._0,model.prototypes)
           ,editMode: Stamp});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "RegisterPrototype": var model$ = _U.update(model,
           ...
           var newModel = function () {
              ...
              if (_p90.ctor === "Just") {
                    var _p93 = _p90._0;
                    var _p91 = $Util$IdGenerator.$new(model.seed);
                    var newId = _p91._0;
                    var seed = _p91._1;
                    var _p92 = $EquipmentsOperation.rect(_p93);
                    var w = _p92._2;
                    var h = _p92._3;
                    var newPrototypes = A2($Prototypes.register,
                    {ctor: "_Tuple4"
                    ,_0: newId
                    ,_1: $EquipmentsOperation.colorOf(_p93)
                    ,_2: $EquipmentsOperation.nameOf(_p93)
         ...
         case "InputFloorName": var newFloor = A2($Util$UndoRedo.commit,
           model.floor,
           $Floor.changeName(_p34._0));
           var effects = saveFloorEffects($Util$UndoRedo.data(newFloor));
           var newModel = _U.update(model,{floor: newFloor});
           return {ctor: "_Tuple2",_0: newModel,_1: effects};
         case "InputFloorRealWidth": var _p97 = _p34._0;
           var _p94 = function () {
              var _p95 = $String.toInt(_p97);
              if (_p95.ctor === "Err") {
                    return {ctor: "_Tuple2",_0: model.floor,_1: $Effects.none};
                 } else {
                    var _p96 = _p95._0;
                    if (_U.cmp(_p96,0) > 0) {
                          var newFloor = A2($Util$UndoRedo.commit,
                          model.floor,
                          $Floor.changeRealWidth(_p96));
                          var effects = saveFloorEffects($Util$UndoRedo.data(newFloor));
                          return {ctor: "_Tuple2",_0: newFloor,_1: effects};
                       } else return {ctor: "_Tuple2"
                                     ,_0: model.floor
                                     ,_1: $Effects.none};
                 }
           }();
           var newFloor = _p94._0;
           var effects = _p94._1;
           var newModel = _U.update(model,
           {floor: newFloor,inputFloorRealWidth: _p97});
           return {ctor: "_Tuple2",_0: newModel,_1: effects};
         case "InputFloorRealHeight": var _p101 = _p34._0;
           var _p98 = function () {
              var _p99 = $String.toInt(_p101);
              if (_p99.ctor === "Err") {
                    return {ctor: "_Tuple2",_0: model.floor,_1: $Effects.none};
                 } else {
                    var _p100 = _p99._0;
           ...
           var newFloor = _p98._0;
           var effects = _p98._1;
           var newModel = _U.update(model,
           {floor: newFloor,inputFloorRealHeight: _p101});
           return {ctor: "_Tuple2",_0: newModel,_1: effects};
         case "Rotate": var newFloor = A2($Util$UndoRedo.commit,
           model.floor,
           $Floor.rotate(_p34._0));
           var newModel = _U.update(model,
           {floor: newFloor,contextMenu: NoContextMenu});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "Publish": var floor = $Util$UndoRedo.data(model.floor);
           var effects = publishFloorEffects(floor);
           return {ctor: "_Tuple2",_0: model,_1: effects};
         default: var newModel = _U.update(model,
           {errors: A2($List._op["::"],_p34._0,model.errors)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};}
   });
   ...
   return _elm.Model.values = {_op: _op
                              ...
                              ,PenFromScreenPos: PenFromScreenPos
                              ,StampFromScreenPos: StampFromScreenPos
                              ,inputs: inputs
                              ,gridSize: gridSize
                              ,init: init
                              ,NoOp: NoOp
                              ...
                              ,publishFloorEffects: publishFloorEffects
                              ...
                              ,screenToImageWithOffset: screenToImageWithOffset
                              ,stampCandidates: stampCandidates
                              ,temporaryPen: temporaryPen};
};
Elm.View = Elm.View || {};
...
Elm.View = Elm.View || {};
Elm.View.Icons = Elm.View.Icons || {};
Elm.View.Icons.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Icons = _elm.View.Icons || {};
   if (_elm.View.Icons.values) return _elm.View.Icons.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   return _elm.View.Icons.values = {_op: _op
...
Elm.View.View.make = function (_elm) {
   ...
   if (_elm.View.View.values) return _elm.View.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Equipments = Elm.Equipments.make(_elm),
   ...
   $Util$ListUtil = Elm.Util.ListUtil.make(_elm),
   $Util$UndoRedo = Elm.Util.UndoRedo.make(_elm),
   $View$Icons = Elm.View.Icons.make(_elm),
   $View$Styles = Elm.View.Styles.make(_elm);
   var _op = {};
   var publishButtonView = F2(function (address,model) {
      return A2($Html.button,
      _U.list([A2($Util$HtmlUtil.onClick$,address,$Model.Publish)
              ,$Html$Attributes.style($View$Styles.publishButton)]),
      _U.list([$Html.text("Publish")]));
   });
   var colorPropertyView = F2(function (address,model) {
      ...
      var viewForEach = function (color) {
         return A2($Html.li,
         _U.list([$Html$Attributes.style(A2($View$Styles.colorProperty,
                 color,
                 match(color)))
                 ,A2($Util$HtmlUtil.onMouseDown$,
                 address,
   ...
   var modeSelectionView = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
              $View$Styles.selection(_U.eq(model.editMode,$Model.Select)),
              widthStyle))
              ,A2($Util$HtmlUtil.onClick$,
              address,
              $Model.ChangeMode($Model.Select))]),
      _U.list([$View$Icons.selectMode(_U.eq(model.editMode,
      $Model.Select))]));
      var pen = A2($Html.div,
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
              $View$Styles.selection(_U.eq(model.editMode,$Model.Pen)),
              widthStyle))
              ,A2($Util$HtmlUtil.onClick$,
              address,
              $Model.ChangeMode($Model.Pen))]),
      _U.list([$View$Icons.penMode(_U.eq(model.editMode,
      $Model.Pen))]));
      var stamp = A2($Html.div,
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
              $View$Styles.selection(_U.eq(model.editMode,$Model.Stamp)),
              widthStyle))
              ,A2($Util$HtmlUtil.onClick$,
              address,
              $Model.ChangeMode($Model.Stamp))]),
      _U.list([$View$Icons.stampMode(_U.eq(model.editMode,
      $Model.Stamp))]));
      return A2($Html.div,
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
      $View$Styles.flex,
   ...
   defence) {
      ...
      defence ? _U.list([A2($Util$HtmlUtil.onMouseDown$,
      address,
      $Model.NoOp)]) : _U.list([]));
   });
   var floorNameInputView = F2(function (address,model) {
      var nameInput = A2($Html.input,
      A2($Basics._op["++"],
      _U.list([$Html$Attributes.id("floor-name-input")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.style($View$Styles.floorNameInput)]),
      A5(inputAttributes,
      address,
      ...
      false)),
      _U.list([]));
      var floorNameLabel = A2($Html.label,
      _U.list([$Html$Attributes.style($View$Styles.floorNameLabel)]),
      _U.list([$Html.text("Name")]));
      return A2($Html.div,
      _U.list([]),
      _U.list([floorNameLabel,nameInput]));
   });
   var floorRealSizeInputView = F2(function (address,model) {
      var heightLabel = A2($Html.label,
      _U.list([$Html$Attributes.style($View$Styles.widthHeightLabel)]),
      _U.list([$Html.text("Height(m)")]));
      var widthLabel = A2($Html.label,
      _U.list([$Html$Attributes.style($View$Styles.widthHeightLabel)]),
      _U.list([$Html.text("Width(m)")]));
      var useReal = true;
      ...
      _U.list([$Html$Attributes.id("floor-real-width-input")
              ...
              ,$Html$Attributes.style($View$Styles.realSizeInput)]),
      A5(inputAttributes,
      address,
      ...
      return A2($Html.div,
      _U.list([]),
      _U.list([widthLabel,widthInput,heightLabel,heightInput]));
   });
   var floorView = F2(function (address,model) {
      return _U.list([A3($Util$HtmlUtil.fileLoadButton,
                     A2($Signal.forwardTo,address,$Model.LoadFile),
                     $View$Styles.imageLoadButton,
                     "Load Image")
                     ,A2(floorNameInputView,address,model)
                     ,A2(floorRealSizeInputView,address,model)
                     ,A2(publishButtonView,address,model)]);
   });
   ...
   var nameInputView = F2(function (address,model) {
      ...
      if (_p1.ctor === "Just") {
            ...
            if (_p2.ctor === "Just") {
                  ...
                  $View$Styles.deskInput(A2($Scale.imageToScreenForRect,
                  model.scale,
                  _p2._0._1)),
                  $View$Styles.transition(transitionDisabled(model)));
   ...
   name) {
      var styles = A2($Basics._op["++"],
      $View$Styles.nameLabel(1.0 / $Basics.toFloat(A2($Scale.screenToImage,
      scale,
      1))),
      $View$Styles.transition(disableTransition));
      return A2($Html.pre,
      _U.list([$Html$Attributes.style(styles)]),
      _U.list([$Html.text(name)]));
   });
   ...
   disableTransition) {
      ...
      var styles = A2($Basics._op["++"],
      A4($View$Styles.desk,screenRect,color,selected,alpha),
      A2($Basics._op["++"],
   ...
   stampMode) {
      ...
      function (label) {
         ...
         _U.list([$Html$Attributes.style(A2($List._op["::"],
                 position,
                 $View$Styles.prototypePreviewScroll))
                 ,A2($Util$HtmlUtil.onClick$,
                 address,
                 _U.eq(label,
      ...
      _U.list([$Html$Attributes.style($View$Styles.prototypePreviewViewInner(selectedIndex))]),
      A2($List.indexedMap,each,prototypes));
      return A2($Html.div,
      _U.list([$Html$Attributes.style($View$Styles.prototypePreviewView(stampMode))]),
      A2($List._op["::"],inner,buttons));
   });
   var penView = F2(function (address,model) {
      var prototypes = $Prototypes.prototypes(model.prototypes);
      return _U.list([A2(modeSelectionView,address,model)
   ...
   var subView = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style($View$Styles.subMenu)]),
      _U.list([card(A2(penView,address,model))
              ,card(A2(propertyView,address,model))
              ,card(A2(floorView,address,model))
   ...
   var temporaryPenView = F2(function (model,from) {
      var _p16 = A2($Model.temporaryPen,model,from);
      if (_p16.ctor === "Just") {
            var _p20 = _p16._0._2._2;
            var _p19 = _p16._0._2._1;
            var _p18 = _p16._0._2._0;
            var _p17 = _p16._0._2._3;
            return A9(equipmentView$,
            A2($Basics._op["++"],
            "temporary_",
            A2($Basics._op["++"],
            ...
            "_",
            A2($Basics._op["++"],
            $Basics.toString(_p19),
            A2($Basics._op["++"],
            "_",
            A2($Basics._op["++"],
            $Basics.toString(_p20),
            A2($Basics._op["++"],"_",$Basics.toString(_p17)))))))),
            {ctor: "_Tuple4",_0: _p18,_1: _p19,_2: _p20,_3: _p17},
            _p16._0._0,
            _p16._0._1,
            false,
            false,
   ...
   disableTransition) {
      ...
      var _p26 = _p21._1._0;
      var _p25 = _p21._0;
      var contextMenu = contextMenuDisabled ? _U.list([]) : _U.list([A2($Util$HtmlUtil.onContextMenu$,
      address,
      $Model.ShowContextMenuOnEquipment(_p25))]);
      var eventHandlers = A2($Basics._op["++"],
      contextMenu,
      _U.list([A2($Util$HtmlUtil.onMouseDown$,
              address,
              $Model.MouseDownOnEquipment(_p25))
              ,A2($Util$HtmlUtil.onDblClick$,
              address,
              $Model.StartEditEquipment(_p25))]));
      var _p22 = function () {
         var _p23 = moving;
         if (_p23.ctor === "Just" && _p23._0.ctor === "_Tuple2" && _p23._0._0.ctor === "_Tuple2" && _p23._0._1.ctor === "_Tuple2")
         {
               var _p24 = A2($Scale.screenToImageForPosition,
               model.scale,
               {ctor: "_Tuple2"
               ,_0: _p23._0._1._0 - _p23._0._0._0
               ,_1: _p23._0._1._1 - _p23._0._0._1});
               var dx = _p24._0;
               var dy = _p24._1;
               return A2($EquipmentsOperation.fitToGrid,
               model.gridSize,
               {ctor: "_Tuple2",_0: _p26 + dx,_1: _p27 + dy});
            } else {
      ...
      return A9(equipmentView$,
      A2($Basics._op["++"],_p25,$Basics.toString(movingBool)),
      {ctor: "_Tuple4",_0: x,_1: y,_2: _p21._1._2,_3: _p21._1._3},
      _p21._2,
      _p21._3,
      selected,
      alpha,
   ...
   var canvasView = F2(function (address,model) {
      var _p28 = model.offset;
      var offsetX = _p28._0;
      var offsetY = _p28._1;
      var temporaryPen$ = function () {
         var _p29 = model.draggingContext;
         if (_p29.ctor === "PenFromScreenPos" && _p29._0.ctor === "_Tuple2")
         {
               return A2(temporaryPenView,
               model,
      ...
      var isDragged = function (equipment) {
         return function () {
            var _p30 = model.draggingContext;
            if (_p30.ctor === "MoveEquipment") {
                  return true;
               } else {
                  return false;
               }
      ...
      var selectorRect = function () {
         ...
         if (_p31.ctor === "_Tuple2" && _p31._0.ctor === "Select" && _p31._1.ctor === "Just")
         {
               return A2($Html.div,
               _U.list([$Html$Attributes.style(A2($Basics._op["++"],
               $View$Styles.selectorRect(A2($Scale.imageToScreenForRect,
               model.scale,
               _p31._1._0)),
               $View$Styles.transition(disableTransition)))]),
               _U.list([]));
      ...
      var draggingEquipments = function () {
         if (function () {
            var _p32 = model.draggingContext;
            if (_p32.ctor === "MoveEquipment") {
                  return true;
               } else {
                  return false;
               }
               ...
               var moving = function () {
                  ...
                  if (_p34.ctor === "MoveEquipment" && _p34._1.ctor === "_Tuple2")
                  {
                        return $Maybe.Just({ctor: "_Tuple2"
                                           ,_0: {ctor: "_Tuple2",_0: _p34._1._0,_1: _p34._1._1}
                                           ,_1: {ctor: "_Tuple2",_0: x,_1: y}});
                     } else {
                        return $Maybe.Nothing;
                     }
               }();
   ...
   var canvasContainerView = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
              ...
              ,A2($Util$HtmlUtil.onMouseUp$,address,$Model.MouseUpOnCanvas)
              ,A2($Util$HtmlUtil.onMouseEnter$,address,$Model.EnterCanvas)
              ,A2($Util$HtmlUtil.onMouseLeave$,address,$Model.LeaveCanvas)
   ...
   var mainView = F2(function (address,model) {
      var _p35 = model.windowDimensions;
      var windowWidth = _p35._0;
      var windowHeight = _p35._1;
      var height = windowHeight - $View$Styles.headerHeight;
      return A2($Html.main$,
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
      $View$Styles.flex,
      _U.list([{ctor: "_Tuple2"
   ...
   var contextMenuItemView = F3(function (address,action,text$) {
      ...
      _U.list([$Html$Attributes.$class("hovarable")
              ,$Html$Attributes.style($View$Styles.contextMenuItem)
              ,A2($Util$HtmlUtil.onMouseDown$,address,action)]),
      _U.list([$Html.text(text$)]));
   });
   var contextMenuView = F2(function (address,model) {
      var _p36 = model.contextMenu;
      if (_p36.ctor === "NoContextMenu") {
            return $Html.text("");
         } else {
            var _p37 = _p36._1;
            return A2($Html.div,
            _U.list([$Html$Attributes.style(A3($View$Styles.contextMenu,
            {ctor: "_Tuple2",_0: _p36._0._0,_1: _p36._0._1 + 37},
            {ctor: "_Tuple2"
            ...
            _U.list([A3(contextMenuItemView,
                    address,
                    $Model.SelectIsland(_p37),
                    "Select Island")
                    ,A3(contextMenuItemView,
                    address,
                    $Model.RegisterPrototype(_p37),
                    "Register as stamp")
                    ,A3(contextMenuItemView,
                    address,
                    $Model.Rotate(_p37),
   ...
   return _elm.View.View.values = {_op: _op,view: view};
};
Elm.Main = Elm.Main || {};
