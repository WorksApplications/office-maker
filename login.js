...
Elm.API.make = function (_elm) {
   ...
   var encodeEquipment = function (_p1) {
      var _p2 = _p1;
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                          ,_0: "id"
                                          ,_1: $Json$Encode.string(_p2._0)}
                                         ,{ctor: "_Tuple2",_0: "type",_1: $Json$Encode.string("desk")}
                                         ,{ctor: "_Tuple2",_0: "x",_1: $Json$Encode.$int(_p2._1._0)}
                                         ,{ctor: "_Tuple2",_0: "y",_1: $Json$Encode.$int(_p2._1._1)}
                                         ,{ctor: "_Tuple2",_0: "width",_1: $Json$Encode.$int(_p2._1._2)}
                                         ,{ctor: "_Tuple2",_0: "height",_1: $Json$Encode.$int(_p2._1._3)}
                                         ,{ctor: "_Tuple2",_0: "color",_1: $Json$Encode.string(_p2._2)}
                                         ,{ctor: "_Tuple2"
                                          ,_0: "name"
                                          ,_1: $Json$Encode.string(_p2._3)}]));
   };
   var encodeFloor = function (floor) {
      var src = function () {
         var _p3 = floor.imageSource;
         switch (_p3.ctor)
         {case "LocalFile": return $Json$Encode.string(_p3._0);
            case "URL": return $Json$Encode.string(_p3._0);
      ...
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                         ...
                                         ,{ctor: "_Tuple2"
                                          ,_0: "realSize"
                                          ,_1: function () {
                                             var _p4 = floor.realSize;
                                             if (_p4.ctor === "Just") {
                                                   return $Json$Encode.list(_U.list([$Json$Encode.$int(_p4._0._0)
                                                                                    ,$Json$Encode.$int(_p4._0._1)]));
                                                } else {
...
Elm.Main.make = function (_elm) {
   ...
   var Model = F3(function (a,b,c) {
      return {error: a,inputId: b,inputPass: c};
   });
   var NoOp = {ctor: "NoOp"};
   ...
   var update = F2(function (action,model) {
      ...
      {case "InputId": return {ctor: "_Tuple2"
                              ...
                              ,_1: $Effects.none};
         case "InputPass": return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{inputPass: _p0._0})
                                  ,_1: $Effects.none};
         case "Submit": var task = A2($Task.onError,
           A2($Task.andThen,
           A2($API.login,model.inputId,model.inputPass),
           function (_p1) {
   ...
   var InputPass = function (a) {
      return {ctor: "InputPass",_0: a};
   };
   var InputId = function (a) {
      return {ctor: "InputId",_0: a};
   };
   var loginForm = F2(function (address,model) {
      return A4($Util$HtmlUtil.form$,
      address,
      Submit,
      _U.list([]),
      _U.list([A2($Html.div,
